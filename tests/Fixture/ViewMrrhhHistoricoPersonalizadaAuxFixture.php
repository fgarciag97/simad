...
/**
 * ViewMrrhhHistoricoPersonalizadaAuxFixture
 */
class ViewMrrhhHistoricoPersonalizadaAuxFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'view_mrrhh_historico_personalizada_aux';
    /**
     * Fields
     *
     * @var array
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'fecha_ingreso_institucion' => '2019-12-23',
                'fecha_egreso_institucion' => '2019-12-23',
