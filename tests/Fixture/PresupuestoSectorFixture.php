...
/**
 * PresupuestoSectorFixture
 */
class PresupuestoSectorFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'presupuesto_sector';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        'sector' => ['type' => 'text', 'length' => null, 'default' => null, 'null' => false, 'collate' => null, 'comment' => null, 'precision' => null],
        ...
        '_constraints' => [
            ...
            'presupuesto_sector_sector_key' => ['type' => 'unique', 'columns' => ['sector'], 'length' => []],
            'presupuesto_sector_n_resolucion_fkey' => ['type' => 'foreign', 'columns' => ['n_resolucion'], 'references' => ['resoluciones', 'n_resolucion'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
