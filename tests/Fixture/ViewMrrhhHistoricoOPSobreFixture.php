...
/**
 * ViewMrrhhHistoricoOPSobreFixture
 */
class ViewMrrhhHistoricoOPSobreFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'view_mrrhh_historico_o_p_sobre';
    /**
     * Fields
     *
     * @var array
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'fecha_egreso_institucion' => '2020-01-10',
