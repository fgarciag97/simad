...
/**
 * ViewMrrhhComisionServicioFixture
 */
class ViewMrrhhComisionServicioFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'view_mrrhh_comision_servicio';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        'grado_instruccion' => ['type' => 'integer', 'length' => 10, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'fecha_ingreso_institucion' => '2020-02-03',
                'fecha_egreso_institucion' => '2020-02-03',
                'anos_institucion' => 1,
                'ano_servicio' => 1,
