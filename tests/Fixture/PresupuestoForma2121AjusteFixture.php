...
/**
 * PresupuestoForma2121AjusteFixture
 */
class PresupuestoForma2121AjusteFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'presupuesto_forma2121_ajuste';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        'tipo_ajuste' => ['type' => 'text', 'length' => null, 'default' => '+', 'null' => true, 'collate' => null, 'comment' => null, 'precision' => null],
        'incrementar' => ['type' => 'decimal', 'length' => 26, 'default' => '0.00', 'null' => true, 'comment' => null, 'precision' => 2, 'unsigned' => null],
        'disminuir' => ['type' => 'decimal', 'length' => 26, 'default' => '0.00', 'null' => true, 'comment' => null, 'precision' => 2, 'unsigned' => null],
        ...
        '_constraints' => [
            ...
            'presupuesto_forma2121_ajuste_n_resolucion_fkey' => ['type' => 'foreign', 'columns' => ['n_resolucion'], 'references' => ['resoluciones', 'n_resolucion'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
