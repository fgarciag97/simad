...
/**
 * EjecucionRequisicionCompraFixture
 */
class EjecucionRequisicionCompraFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'ejecucion_requisicion_compra';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'ejecucion_requisicion_compra_id_requisicion_fkey' => ['type' => 'foreign', 'columns' => ['id_requisicion'], 'references' => ['compra_requisicion', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
