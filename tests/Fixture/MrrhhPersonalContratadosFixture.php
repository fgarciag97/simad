...
/**
 * MrrhhPersonalContratadosFixture
 */
class MrrhhPersonalContratadosFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'mrrhh_personal_contratados_cargo_fkey' => ['type' => 'foreign', 'columns' => ['cargo'], 'references' => ['mrrhh_cargos_contratados', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_personal_contratados_grado_fkey' => ['type' => 'foreign', 'columns' => ['grado'], 'references' => ['grado', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_personal_contratados_grupo_fkey' => ['type' => 'foreign', 'columns' => ['grupo'], 'references' => ['mrrhh_grupos', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_personal_contratados_tipo_nomina_fkey' => ['type' => 'foreign', 'columns' => ['tipo_nomina'], 'references' => ['mrrhh_nomina', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_personal_contratados_tipo_personal_fkey' => ['type' => 'foreign', 'columns' => ['tipo_personal'], 'references' => ['mrrhh_tipo_personal', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
