...
/**
 * ViewMrrhhPrestacionesSocialesxFixture
 */
class ViewMrrhhPrestacionesSocialesxFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'view_mrrhh_prestaciones_socialesx';
    /**
     * Fields
     *
     * @var array
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'fecha_ingreso_institucion' => '2020-02-01',
                'fecha_egreso_institucion' => '2020-02-01',
