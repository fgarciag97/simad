...
/**
 * ViewMrrhhObrerosNoPermanentesAuxFixture
 */
class ViewMrrhhObrerosNoPermanentesAuxFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'view_mrrhh_obreros_no_permanentes_aux';
    /**
     * Fields
     *
     * @var array
