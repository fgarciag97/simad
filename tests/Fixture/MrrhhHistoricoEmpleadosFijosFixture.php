...
/**
 * MrrhhHistoricoEmpleadosFijosFixture
 */
class MrrhhHistoricoEmpleadosFijosFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'prima_hijos' => ['type' => 'decimal', 'length' => 26, 'default' => '31250.00', 'null' => true, 'comment' => null, 'precision' => 2, 'unsigned' => null],
        ...
        '_constraints' => [
            ...
            'mrrhh_historico_empleados_fijos_cedula_fkey' => ['type' => 'foreign', 'columns' => ['cedula'], 'references' => ['mrrhh_personal', 'cedula'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_historico_empleados_fijos_id_tipo_personal_fkey' => ['type' => 'foreign', 'columns' => ['id_tipo_personal'], 'references' => ['mrrhh_tipo_personal', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_historico_empleados_fijos_mes_fkey' => ['type' => 'foreign', 'columns' => ['mes'], 'references' => ['mes', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_historico_empleados_fijos_quincena_fkey' => ['type' => 'foreign', 'columns' => ['quincena'], 'references' => ['quincena', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_historico_empleados_fijos_requisicion_fkey' => ['type' => 'foreign', 'columns' => ['requisicion'], 'references' => ['mrrhh_requisicion', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
