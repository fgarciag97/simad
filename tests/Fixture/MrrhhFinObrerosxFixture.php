...
/**
 * MrrhhFinObrerosxFixture
 */
class MrrhhFinObrerosxFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'mrrhh_fin_obrerosx';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        'fecha_desde' => ['type' => 'date', 'length' => null, 'default' => 'CURRENT_DATE', 'null' => true, 'comment' => null, 'precision' => null],
        ...
        '_constraints' => [
            ...
            'mrrhh_fin_obrerosx_cedula_fkey' => ['type' => 'foreign', 'columns' => ['cedula'], 'references' => ['mrrhh_personal', 'cedula'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_fin_obrerosx_id_tipo_personal_fkey' => ['type' => 'foreign', 'columns' => ['id_tipo_personal'], 'references' => ['mrrhh_tipo_personal', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_fin_obrerosx_requisicion_fkey' => ['type' => 'foreign', 'columns' => ['requisicion'], 'references' => ['mrrhh_requisicion', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'bono_vacacional' => 1.5,
                'disfrute' => 1.5,
                'fecha_desde' => '2020-06-03',
                'fecha_hasta' => '2020-06-03',
                'fecha_reintegro' => '2020-06-03',
                'cantidad_dias' => 1,
                'alicuota_v' => 1,
                'alicuota_f' => 1,
                'alicuota' => 1,
