...
/**
 * ViewMrrhhHistoricoComisionServicioFixture
 */
class ViewMrrhhHistoricoComisionServicioFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'view_mrrhh_historico_comision_servicio';
    /**
     * Fields
     *
     * @var array
