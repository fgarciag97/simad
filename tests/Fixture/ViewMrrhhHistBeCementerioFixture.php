...
/**
 * ViewMrrhhHistBeCementerioFixture
 */
class ViewMrrhhHistBeCementerioFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'view_mrrhh_hist_be_cementerio';
    /**
     * Fields
     *
     * @var array
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'fecha_ingreso_institucion' => '2020-01-27',
                'fecha_egreso_institucion' => '2020-01-27',
