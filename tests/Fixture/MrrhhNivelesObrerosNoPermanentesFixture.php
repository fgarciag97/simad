...
/**
 * MrrhhNivelesObrerosNoPermanentesFixture
 */
class MrrhhNivelesObrerosNoPermanentesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'mrrhh_niveles_obreros_no_permanentes_grupo_fkey' => ['type' => 'foreign', 'columns' => ['grupo'], 'references' => ['mrrhh_grupos_obreros_no_permanentes', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
