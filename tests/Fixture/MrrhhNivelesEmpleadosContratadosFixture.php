...
/**
 * MrrhhNivelesEmpleadosContratadosFixture
 */
class MrrhhNivelesEmpleadosContratadosFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'mrrhh_niveles_empleados_contratados_grupo_fkey' => ['type' => 'foreign', 'columns' => ['grupo'], 'references' => ['mrrhh_grupos_empleados_contratados', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
