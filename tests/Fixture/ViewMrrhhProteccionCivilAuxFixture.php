...
/**
 * ViewMrrhhProteccionCivilAuxFixture
 */
class ViewMrrhhProteccionCivilAuxFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'view_mrrhh_proteccion_civil_aux';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        'grado_nivel' => ['type' => 'decimal', 'length' => 26, 'default' => null, 'null' => true, 'comment' => null, 'precision' => 6, 'unsigned' => null],
        'denominacion_grado_nivel' => ['type' => 'string', 'length' => 5, 'default' => null, 'null' => true, 'collate' => null, 'comment' => null, 'precision' => null, 'fixed' => null],
