...
/**
 * ViewMrrhhEmpleadosContratadosAuxFixture
 */
class ViewMrrhhEmpleadosContratadosAuxFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'view_mrrhh_empleados_contratados_aux';
    /**
     * Fields
     *
     * @var array
