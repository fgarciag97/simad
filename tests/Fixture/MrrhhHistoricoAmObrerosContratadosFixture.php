...
/**
 * MrrhhHistoricoAmObrerosContratadosFixture
 */
class MrrhhHistoricoAmObrerosContratadosFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'mrrhh_historico_am_obreros_contratados_cedula_fkey' => ['type' => 'foreign', 'columns' => ['cedula'], 'references' => ['mrrhh_personal', 'cedula'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_historico_am_obreros_contratados_id_tipo_personal_fkey' => ['type' => 'foreign', 'columns' => ['id_tipo_personal'], 'references' => ['mrrhh_tipo_personal', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_historico_am_obreros_contratados_mes_fkey' => ['type' => 'foreign', 'columns' => ['mes'], 'references' => ['mes', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_historico_am_obreros_contratados_quincena_fkey' => ['type' => 'foreign', 'columns' => ['quincena'], 'references' => ['quincena', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_historico_am_obreros_contratados_requisicion_fkey' => ['type' => 'foreign', 'columns' => ['requisicion'], 'references' => ['mrrhh_requisicion', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
