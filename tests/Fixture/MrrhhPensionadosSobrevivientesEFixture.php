...
/**
 * MrrhhPensionadosSobrevivientesEFixture
 */
class MrrhhPensionadosSobrevivientesEFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'mrrhh_pensionados_sobrevivientes_e';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'mrrhh_pensionados_sobrevivientes_e_cargo_fkey' => ['type' => 'foreign', 'columns' => ['cargo'], 'references' => ['mrrhh_cargos_pensionados', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_pensionados_sobrevivientes_e_cedula_fkey' => ['type' => 'foreign', 'columns' => ['cedula'], 'references' => ['mrrhh_personal', 'cedula'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_pensionados_sobrevivientes_e_nivel_fkey' => ['type' => 'foreign', 'columns' => ['nivel'], 'references' => ['mrrhh_niveles_empleados', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_pensionados_sobrevivientes_e_tipo_nomina_fkey' => ['type' => 'foreign', 'columns' => ['tipo_nomina'], 'references' => ['mrrhh_tipo_nomina', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_pensionados_sobrevivientes_e_tipo_personal_fkey' => ['type' => 'foreign', 'columns' => ['tipo_personal'], 'references' => ['mrrhh_tipo_personal', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
