...
/**
 * CompraOrdenServicioItemsFixture
 */
class CompraOrdenServicioItemsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'compra_orden_servicio_items_id_orden_fkey' => ['type' => 'foreign', 'columns' => ['id_orden'], 'references' => ['compra_orden_compras', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'compra_orden_servicio_items_id_partida_fkey' => ['type' => 'foreign', 'columns' => ['id_partida'], 'references' => ['presupuesto_forma2121', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'compra_orden_servicio_items_unidad_solicitante_fkey' => ['type' => 'foreign', 'columns' => ['unidad_solicitante'], 'references' => ['presupuesto_forma2121', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
