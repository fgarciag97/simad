...
/**
 * ViewMrrhhHistoricoRetroactivoVxFixture
 */
class ViewMrrhhHistoricoRetroactivoVxFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'view_mrrhh_historico_retroactivo_vx';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        'sueldo_anterior' => ['type' => 'decimal', 'length' => 26, 'default' => null, 'null' => true, 'comment' => null, 'precision' => 2, 'unsigned' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'fecha_ingreso_institucion' => '2020-05-15',
                'fecha_egreso_institucion' => '2020-05-15',
