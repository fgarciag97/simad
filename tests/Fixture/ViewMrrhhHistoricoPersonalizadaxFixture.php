...
/**
 * ViewMrrhhHistoricoPersonalizadaxFixture
 */
class ViewMrrhhHistoricoPersonalizadaxFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'view_mrrhh_historico_personalizadax';
    /**
     * Fields
     *
     * @var array
