...
/**
 * MrrhhObrerosContratadosFixture
 */
class MrrhhObrerosContratadosFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'mrrhh_obreros_contratados_cargo_fkey' => ['type' => 'foreign', 'columns' => ['cargo'], 'references' => ['mrrhh_cargos_obreros_contratados', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_obreros_contratados_cedula_fkey' => ['type' => 'foreign', 'columns' => ['cedula'], 'references' => ['mrrhh_personal', 'cedula'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_obreros_contratados_nivel_fkey' => ['type' => 'foreign', 'columns' => ['nivel'], 'references' => ['mrrhh_niveles_obreros', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_obreros_contratados_tipo_nomina_fkey' => ['type' => 'foreign', 'columns' => ['tipo_nomina'], 'references' => ['mrrhh_tipo_nomina', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'mrrhh_obreros_contratados_tipo_personal_fkey' => ['type' => 'foreign', 'columns' => ['tipo_personal'], 'references' => ['mrrhh_tipo_personal', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
