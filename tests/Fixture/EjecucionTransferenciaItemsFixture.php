...
/**
 * EjecucionTransferenciaItemsFixture
 */
class EjecucionTransferenciaItemsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'ejecucion_transferencia_items_id_orden_fkey' => ['type' => 'foreign', 'columns' => ['id_orden'], 'references' => ['ejecucion_transferencia', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'ejecucion_transferencia_items_id_partida_fkey' => ['type' => 'foreign', 'columns' => ['id_partida'], 'references' => ['presupuesto_forma2121', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'ejecucion_transferencia_items_unidad_solicitante_fkey' => ['type' => 'foreign', 'columns' => ['unidad_solicitante'], 'references' => ['presupuesto_forma2121', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
