...
/**
 * PresupuestoRamoFixture
 */
class PresupuestoRamoFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        'ramo' => ['type' => 'text', 'length' => null, 'default' => null, 'null' => false, 'collate' => null, 'comment' => null, 'precision' => null],
        ...
        '_constraints' => [
            ...
            'presupuesto_ramo_n_resolucion_fkey' => ['type' => 'foreign', 'columns' => ['n_resolucion'], 'references' => ['resoluciones', 'n_resolucion'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
