...
/**
 * ViewMrrhhHonorarioProfesionalesAuxFixture
 */
class ViewMrrhhHonorarioProfesionalesAuxFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'view_mrrhh_honorario_profesionales_aux';
    /**
     * Fields
     *
     * @var array
