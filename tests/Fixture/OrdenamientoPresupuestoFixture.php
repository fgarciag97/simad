...
/**
 * OrdenamientoPresupuestoFixture
 */
class OrdenamientoPresupuestoFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'ordenamiento_presupuesto';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'ordenamiento_presupuesto_id_requisicion_fkey' => ['type' => 'foreign', 'columns' => ['id_requisicion'], 'references' => ['compra_requisicion', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
