...
/**
 * OrdenamientoServicioFixture
 */
class OrdenamientoServicioFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'ordenamiento_servicio';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'ordenamiento_servicio_id_requisicion_fkey' => ['type' => 'foreign', 'columns' => ['id_requisicion'], 'references' => ['mrrhh_requisicion_servicios', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
