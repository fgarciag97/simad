...
/**
 * OrdenamientoNominaFixture
 */
class OrdenamientoNominaFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'ordenamiento_nomina';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'ordenamiento_nomina_id_requisicion_fkey' => ['type' => 'foreign', 'columns' => ['id_requisicion'], 'references' => ['mrrhh_requisicion', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
