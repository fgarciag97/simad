...
/**
 * EjecucionRequisicionNominaFixture
 */
class EjecucionRequisicionNominaFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'ejecucion_requisicion_nomina';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        'monto_comprometer' => ['type' => 'decimal', 'length' => 26, 'default' => null, 'null' => false, 'comment' => null, 'precision' => 2, 'unsigned' => null],
        'ano' => ['type' => 'integer', 'length' => 10, 'default' => null, 'null' => false, 'comment' => null, 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
        'fecha' => ['type' => 'date', 'length' => null, 'default' => 'CURRENT_DATE', 'null' => false, 'comment' => null, 'precision' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'ejecucion_requisicion_nomina_id_requisicion_fkey' => ['type' => 'foreign', 'columns' => ['id_requisicion'], 'references' => ['mrrhh_requisicion', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
