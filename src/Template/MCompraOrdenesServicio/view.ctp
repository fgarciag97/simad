...
<?= $this->Form->create('MCompraOrdenesServicio', array('class'=>'well', 'type' => 'post', 'url' => array('controller' => 'MCompraOrdenesServicio', 'action' => 'view'))) ?>
	...
	<table class="table table-responsive">
		<tr>
			...
			<td><div id="" class="input-group">
					...
					<?= $this->Form->input('precio_unitario', ['type' => 'text', 'label' => false, 'class'=> 'form-control', 'required', 'autocomplete' => 'off', 'onKeyPress' => 'return soloNum(event);', 'onchange' => 'orden(this.value);', 'id' => 'precio_unitario']); ?>
				</div>
			</td>
			<td><div id="" class="input-group">
		...
		<tr>
			<td>
				<a data-toggle="modal" 
                        ...
                        id_orden   ="<?= $orden['id'] ?>"
		                requisicion   ="<?= $req ?>"
                      onclick="editar_orden_servicio(this);" class="btn btn-warning pull-left">Editar Orden</a>
			</td>
			<td>
				    ...
				    <tr style="text-align: center;">
				        ...
				        <td>
				        	<a data-toggle="modal" id = "<?= $reg->id ?>" 
		                      ...
		                      onclick="editar_item_servicio(this);" class="btn btn-warning btn-xs">Editar</a>
