 ...
 <?= $this->Form->create($registro, ['class'=>'well']);?>
	...
	<div id="" class="input-group">
		...
		<?= $this->Form->input('responsable', ['type' => 'text', 'label' => false, 'class'=> 'form-control', 'required', 'maxlength' => '50', 'placeholder' => 'Nombre y Apellido', 'autocomplete' => 'off', 'onkeyup' => 'mayus(this);']); ?>
	</div>
	...
	<div id="" class="input-group">
		...
		<?= $this->Form->input('username', ['type' => 'text', 'label' => false, 'class'=> 'form-control', 'required', 'maxlength' => '20', 'placeholder' => 'Ingrese Usuario', 'autocomplete' => 'off', 'onkeyup' => 'mayus(this);']); ?>
	</div>
	...
	<div id="" class="input-group">
		...
		<?= $this->Form->input('password2', ['type' => 'password', 'label' => false, 'class'=> 'form-control', 'required', 'placeholder' => 'Repita la Contraseña', 'autocomplete' => 'off', 'onkeyup' => 'mayus(this);']); ?>
	</div>
