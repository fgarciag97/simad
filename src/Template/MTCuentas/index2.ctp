...
<?= $this->Form->create('MTCuentas', array('class'=>'well', 'type' => 'post', 'url' => array('controller' => 'MTCuentas', 'action' => 'buscar2'))) ?>
	...
	<table class="table table-responsive">
		...
		<thead>
			<tr>
				<th></th>
				<th class="text-center"><strong>Cuentas Destinatarios</strong></th>
				<th></th>
			</tr>
		</thead>
	</table>
			...
			<table class="table table-responsive">
			    ...
			    <?php if (isset($data) && !empty($data)): 
				    ...
				    <tr style="text-align: center;">
				        ...
				        <td>
				         	<?= $this->Html->link(__('Ver'), ['action' => 'view2', $reg->numero_cuenta], ['class' => 'btn btn-danger btn-sm']) ?>
				        </td>
				    </tr>
