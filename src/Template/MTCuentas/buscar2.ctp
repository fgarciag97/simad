...
<?= $this->Form->create('EjecucionBeneficiarios', array('class'=>'well', 'type' => 'post', 'url' => array('controller' => 'EjecucionBeneficiarios', 'action' => 'buscar2'))) ?>
			...
			<table class="table table-responsive">
			    ...
			    <?php if (isset($data) && !empty($data)): 
				    ...
				    <tr style="text-align: center;">
				        ...
				        <td>
				         	<?= $this->Html->link(__('Ver'), ['action' => 'view2', $reg->cedula], ['class' => 'btn btn-danger btn-sm']) ?>
				        </td>
				    </tr>
