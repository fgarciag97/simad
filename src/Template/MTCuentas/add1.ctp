<?php $this->assign('title', 'Registrar cuentas'); ?>
	...
	<?= $this->Form->create(@$cuentas, ['class'=>'well']);?>
		...
		<table class="table table-responsive">
			<tr>
				<td width="60%"><div id="" class="input-group">
				...
				<td width="20%"><div id="" class="input-group">
					<span class="input-group-addon">Saldo</span>
					<?= $this->Form->input('saldo', ['type' => 'text', 'label' => false, 'class'=> 'form-control moneda', 'autocomplete' => 'off', 'onKeyPress' => 'return soloNum(event);']); ?>
				</div></td> 
			</tr>
		</table>
		...
		<table class="table table-responsive">
			...
			<td><div id="" class="input-group">
					...
					<?= $this->Form->input('cedula', ['type' => 'text', 'label' => false, 'class'=> 'form-control', 'onKeyPress' => 'return soloNum(event);', 'autocomplete' => 'off', 'value' => '200001692', 'maxlength' => 9]); ?>
				</div></td>
		</table>
