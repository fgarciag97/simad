<form action="" method="post" id="form_editar_bono">
    <div class="modal fade" id="bono" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <table class="table table-responsive">
                ...
                <tr>
                      <td></td>
                        ...
                        <td>
                          <div class="input-group" on>
                            <input type="text" name="bono_dias_cancelar" id="bono_dias_cancelarbe" class="form-control moneda" onKeyPress='return soloNum(event);' >
                          </div>
                        </td>
                      <td></td>
                <tr>
