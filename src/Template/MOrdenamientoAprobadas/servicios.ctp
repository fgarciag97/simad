<?php $this->assign('title', 'Historial de Orden de Req. Serivicios'); ?>
...
<div class="well">
	...
	<table class="table table-responsive">
		<thead>
			<tr>
				<th></th>
				<th class="text-center"><strong>Ordenes Aprobadas - Requisicion de Servicios</strong></th>
				<th></th>
			</tr>
		</thead>
	</table>
		    	...
		    	foreach($data as $reg){ 
				 ...
				 <tr style="text-align: center;">
			    	...
			    	<td>
			    		<?php 
							if($reg->status == 5){
								echo $this->Html->link("<i class='fa fa-check'></i>",array('action' => 'enviarreqservicio', $reg->id), array('tabindex' => '-1', 'escape' => false, 'class' => 'btn btn-success', 'confirm' => __('Desea enviar a tesoreria la orden # {0}?', $numero_orden_pago)));
