...
<?= $this->Flash->render();?>
	...
	<table class="table table-responsive">
		...
		<thead>
			<tr>
				<th></th>
				<th class="text-center" ><strong>Asociar Proyecto a la Categoria Programatica</strong></th>
				<th></th>
			</tr>
		</thead>
	</table>
		...
		<table class="table table-responsive" style="width: 10%; margin-left: 40%;">
			<tr>
				<td><div id="" class="input-group">
						...
						<?= $this->Form->input('proyecto', ['type' => 'text', 'label' => false, 'class'=> 'form-control', 'required', 'maxlength' => '2',  'onKeyPress' => 'return soloNum(event);']); ?>
					</div>
				</td>
			</tr>
		</table>
		...
		<table class="table table-responsive">
			<tr>
				<td><div id="" class="input-group">
						...
						<?= $this->Form->input('denominacion', ['type' => 'textarea', 'label' => false, 'class'=> 'form-control', 'required', 'onkeyup' => 'mayus(this);']); ?>
					</div>
				</td>
		</tr>
	</table>
		    ...
		    ?>
			    <tr style="text-align: center;">
			        ...
			        <td>
			         	...
			         	<?= $this->Form->postLink('Eliminar', ['action' => 'deleteproyecto', $reg->id, $reg->id_sector, $reg->id_programa, $reg->id_sub_programa], ['confirm' => __('Desea eliminar el proyecto?'), 'class' => 'btn btn-danger btn-xs']) ?>
			        </td>
			    </tr>
