    ...
    foreach ($data as $key) {   
        ...
        if($key['id_tipo_personal'] == 1){
                ...
                foreach ($data2 as $key2) {
                  ...
                  if($key['cantidad_horas_extra_diurnas'] != 0)
                  $diurnas = (((($asignacion) / 30) / 8) * 1.70) * $key['cantidad_horas_extra_diurnas'];
                  else $diurnas = 0;

                  /*====================== Horas Nocturnas ===================*/

                  if($key['cantidad_horas_extra_nocturnas'] != 0)
                  $nocturnas = ((((($asignacion) / 30) / 8) * 1.70) + (((($asignacion) / 30) / 8) * 1.30)) * $key['cantidad_horas_extra_nocturnas'];
                  else $nocturnas = 0;

                  /*====================== Dias no Laborables ===================*/

                  if($key['dias_no_laborables'] != 0)
                  $dias_no_laborables = ((($asignacion) / 30) * 1.50) * $key['dias_no_laborables'];
                  else $dias_no_laborables = 0;
            ...
            }else if($key['id_tipo_personal'] == 3){ 
