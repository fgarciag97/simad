		...
		<tr>	
				...
				<td style="width: 35%;">
					<div id="" class="input-group">
						...
						<?= $this->Form->input('rif', ['type' => 'text', 'label' => false, 'class'=> 'form-control', 'required', 'maxlength' => '10', 'autocomplete' => 'off', 'onKeyPress' => 'return soloNum(event);']); ?>
					</div>
				</td>
				<td style="width: 10%">					    	
	...
	<table class="table table-responsive">
			...
			<tr>
				<td><div id="" class="input-group">
					<span class="input-group-addon">RIF</span>
					<?= $this->Form->input('rif', ['type' => 'text', 'label' => false, 'class'=> 'form-control', 'required', 'maxlength' => '10', 'value' => 'J-', 'onKeyPress' => 'return soloNum(event);']); ?>
				</div></td>

				<td><div id="" class="input-group">
					<span class="input-group-addon">Razon Social</span>
					<?= $this->Form->input('razon_social', ['type' => 'text', 'label' => false, 'class'=> 'form-control']); ?>
				</div></td>
			...
			<table class="table table-responsive">
			    ...
			    <?php if (isset($data) && !empty($data)): 
				    ...
				    <tr style="text-align: center;">
				        ...
				        <td>
				         	<?= $this->Html->link(__('Ver'), ['action' => 'view', $reg->rif], ['class' => 'btn btn-danger btn-sm']) ?>
				        </td>
				    </tr>
