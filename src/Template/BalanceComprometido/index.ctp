...
<div class="well">
	<table class="table table-responsive">
		<thead>
			<tr>
				<th></th>
				<th class="text-center"><strong> Ejecucion Presupuestaria Según Comprometido</strong></th>
				<th></th>
			</tr>
		</thead>
	</table>

	<?= $this->Form->create('BalanceComprometido', array('class'=>'well', 'type' => 'post', 'url' => array('controller' => 'BalanceComprometido', 'action' => 'index'))) ?>
