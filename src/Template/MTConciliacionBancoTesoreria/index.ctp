...
<div class="well">
	<table class="table table-responsive">
		<thead>
			<tr>
				<th></th>
				<th class="text-center"><strong> Conciliacion Bancaria - Tesoreria Municipal</strong></th>
				<th></th>
			</tr>
		</thead>
	</table>
		...
		<tr>
			<td style="width: 100%;">
				<div class="input-group">
					...
					<?= $this->Form->select('cuenta_bancaria', @$cuenta_bancaria, ['empty' => '--Seleccione--', 'class'=> 'form-control', 'required', 'label' => false, 'escape' => false]); ?>
				</div>
			</td>
	...
	<br>
		...
		<table class="table table-responsive">
			...
			<tr style="text-align: center;">
				...
				<td> 0.00</td>
				<td> 15.000.000</td>
				<td><button class = "btn btn-primary btn-xs"><i class='fa fa-exclamation-circle'></i></button></td>
			</tr>
	...
	<table class="table-responsive table" style="width: 30%; position: center; margin-left: 75%; padding: 10px;">
			<tr style="text-align: center;">
				<td><?=$this->Html->link("<i class='fa fa-file-pdf-o'> Conciliacion Bancaria </i>",array('action' => 'libroBancoHaciendaMunicipal'), array('tabindex' => '-1', 'escape' => false, 'class' => 'btn btn-md btn-default', 'target' => '_blank')); ?></td>
