<?php $this->assign('title', 'Resolucion - Proyectos'); ?>
...
<?= $this->Flash->render();?>
	...
	<table class="table table-responsive">
		...
		<thead>
			<tr>
				<th></th>
				<th class="text-center" ><strong>Resolucion - Asociar Proyecto a la Categoria Programatica</strong></th>
				<th></th>
			</tr>
		</thead>
	</table>
		...
		<table class="table table-responsive" >
			<tr>
				<td style="width: 10%;"><div id="" class="input-group">
						...
						<?= $this->Form->input('proyecto', ['type' => 'text', 'label' => false, 'class'=> 'form-control', 'required', 'maxlength' => '3',  'onKeyPress' => 'return soloNum(event);']); ?>
					</div>
				</td>
