 ...
 * @property int|null $numero_orden_pago_ord2
 * @property int|null $numero_orden_pago_ord3
 * @property int|null $numero_orden_pago_ord4
 * @property bool|null $status1
 * @property bool|null $status2
 * @property bool|null $status3
 * @property bool|null $status4
 */
class CompraRequisicion extends Entity
{
    /**
    ...
    protected $_accessible = [
        ...
        'numero_orden_pago_ord2' => true,
        'numero_orden_pago_ord3' => true,
        'numero_orden_pago_ord4' => true,
        'status1' => true,
        'status2' => true,
        'status3' => true,
        'status4' => true
