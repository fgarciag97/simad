...
/**
 * MrrhhHistoricoRetroactivoNominabex Entity
 *
 * @property int $id
 * @property int $ano
 * @property int $mes
 ...
 * @property float|null $porcentaje_aumneto
 ...
 */
class MrrhhHistoricoRetroactivoNominabex extends Entity
{
    /**
