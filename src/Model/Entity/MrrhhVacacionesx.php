 ...
 * @property float|null $monto_av
 * @property bool|null $alicuota_f
 * @property float|null $monto_af
 * @property bool|null $alicuota
 * @property float|null $monto_a
 * @property bool|null $disfrute
 * @property float|null $monto_disfrute
 * @property int|null $quinquenio
 ...
 */
class MrrhhVacacionesx extends Entity
{
    /**
