 ...
 * @property int|null $dias_dejados_c
 * @property float|null $ajuste_sueldo
 * @property float|null $ajuste_p_profesion
 * @property float|null $ajuste_p_antiguedad
 * @property float|null $ajuste_p_hijos
 * @property float|null $ajuste_p_hogar
 * @property float|null $ajuste_sso
 * @property float|null $ajuste_rpe
 * @property float|null $ajuste_faov
 * @property float|null $ajuste_fpj
 * @property float|null $ajuste_caja
 * @property float|null $ajuste_a_sso
 * @property float|null $ajuste_a_rpe
 * @property float|null $ajuste_a_faov
 * @property float|null $ajuste_a_fpj
 * @property float|null $ajuste_a_caja
 * @property int|null $dias
 * @property float|null $bono_vacacional
 * @property float|null $disfrute
 * @property \Cake\I18n\FrozenDate|null $fecha_desde
 * @property \Cake\I18n\FrozenDate|null $fecha_hasta
 * @property \Cake\I18n\FrozenDate|null $fecha_reintegro
 * @property int|null $cantidad_dias
 * @property bool|null $alicuota_v
 * @property bool|null $alicuota_f
 * @property bool|null $alicuota
 * @property bool|null $disfrute_v
 * @property bool|null $bono_v
 * @property int|null $dias_d
 * @property int|null $dias_bono
 * @property float|null $horas_extras
 * @property bool|null $procesado
 */
class MrrhhVacacionesObrero extends Entity
{
    /**
    ...
    protected $_accessible = [
        ...
        'dias_dejados_c' => true,
        'ajuste_sueldo' => true,
        'ajuste_p_profesion' => true,
        'ajuste_p_antiguedad' => true,
        'ajuste_p_hijos' => true,
        'ajuste_p_hogar' => true,
        'ajuste_sso' => true,
        'ajuste_rpe' => true,
