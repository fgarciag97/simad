...
/**
 * ViewMrrhhHistoricoEmpleadosFijo Entity
 *
 ...
 * @property float|null $monto_becas
 * @property bool|null $prima_hogar
 * @property float|null $monto_hogar
 ...
 * @property float|null $monto_funeraria
 * @property bool|null $asociacion_funeraria
 * @property bool|null $sindicato
 * @property float|null $monto_sindicato
 ...
 * @property int|null $omitida
 */
class ViewMrrhhHistoricoEmpleadosFijo extends Entity
{
    /**
    ...
    protected $_accessible = [
        ...
        'funeraria' => true,
        'monto_funeraria' => true,
        'asociacion_funeraria' => true,
        'sindicato' => true,
        'monto_sindicato' => true,
        'hijos' => true,
        'prima_hijos' => true,
        'antiguedad' => true,
