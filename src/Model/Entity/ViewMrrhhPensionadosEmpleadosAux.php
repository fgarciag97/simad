...
/**
 * ViewMrrhhPensionadosEmpleadosAux Entity
 *
 ...
 * @property float|null $x_aporte_patronal_afpj
 * @property float|null $x_aporte_patronal_caja_ahorro
 * @property string|null $ente_adscrito
 */
class ViewMrrhhPensionadosEmpleadosAux extends Entity
{
    /**
