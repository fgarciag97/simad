...
/**
 * MrrhhHistoricoEmpleadosPensionados Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoEmpleadosPensionado get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoEmpleadosPensionado newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoEmpleadosPensionado[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoEmpleadosPensionado|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoEmpleadosPensionado saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoEmpleadosPensionado patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoEmpleadosPensionado[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoEmpleadosPensionado findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoEmpleadosPensionadosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_empleados_pensionados');
