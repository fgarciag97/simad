...
/**
 * ViewMrrhhPenSobreObrerosAux Model
 *
 * @method \App\Model\Entity\ViewMrrhhPenSobreObrerosAux get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreObrerosAux newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreObrerosAux[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreObrerosAux|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreObrerosAux saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreObrerosAux patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreObrerosAux[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreObrerosAux findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhPenSobreObrerosAuxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_pen_sobre_obreros_aux');
    }
