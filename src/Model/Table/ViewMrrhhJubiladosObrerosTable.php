...
/**
 * ViewMrrhhJubiladosObreros Model
 *
 * @method \App\Model\Entity\ViewMrrhhJubiladosObrero get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosObrero newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosObrero[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosObrero|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosObrero saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosObrero patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosObrero[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosObrero findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhJubiladosObrerosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_jubilados_obreros');
    }
