...
/**
 * MrrhhHistoricoBeEmpleadosFijos Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoBeEmpleadosFijo get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeEmpleadosFijo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeEmpleadosFijo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeEmpleadosFijo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeEmpleadosFijo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeEmpleadosFijo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeEmpleadosFijo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeEmpleadosFijo findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoBeEmpleadosFijosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_be_empleados_fijos');
