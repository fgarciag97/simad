...
/**
 * ViewMrrhhHistBeObrerosFijos Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistBeObrerosFijo get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeObrerosFijo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeObrerosFijo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeObrerosFijo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeObrerosFijo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeObrerosFijo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeObrerosFijo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeObrerosFijo findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistBeObrerosFijosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_hist_be_obreros_fijos');
    }
