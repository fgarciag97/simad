...
/**
 * ViewMrrhhHistoricoRetroactivoV Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoRetroactivoV get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoRetroactivoV newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoRetroactivoV[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoRetroactivoV|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoRetroactivoV saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoRetroactivoV patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoRetroactivoV[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoRetroactivoV findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoRetroactivoVTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_retroactivo_v');
    }
