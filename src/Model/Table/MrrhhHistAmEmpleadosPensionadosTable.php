...
/**
 * MrrhhHistAmEmpleadosPensionados Model
 *
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosPensionado get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosPensionado newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosPensionado[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosPensionado|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosPensionado saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosPensionado patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosPensionado[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosPensionado findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistAmEmpleadosPensionadosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_hist_am_empleados_pensionados');
