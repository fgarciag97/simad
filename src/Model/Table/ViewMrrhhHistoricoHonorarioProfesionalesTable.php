...
/**
 * ViewMrrhhHistoricoHonorarioProfesionales Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoHonorarioProfesionale get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoHonorarioProfesionale newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoHonorarioProfesionale[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoHonorarioProfesionale|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoHonorarioProfesionale saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoHonorarioProfesionale patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoHonorarioProfesionale[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoHonorarioProfesionale findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoHonorarioProfesionalesTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_honorario_profesionales');
    }
