...
/**
 * ViewMrrhhHistoricoPersonalizadax Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizadax get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizadax newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizadax[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizadax|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizadax saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizadax patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizadax[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizadax findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoPersonalizadaxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_personalizadax');
    }
