...
/**
 * ViewMrrhhHistoricoEPEsp Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoEPEsp get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEPEsp newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEPEsp[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEPEsp|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEPEsp saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEPEsp patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEPEsp[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEPEsp findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoEPEspTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_e_p_esp');
    }
