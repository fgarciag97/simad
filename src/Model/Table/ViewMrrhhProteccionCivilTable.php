...
/**
 * ViewMrrhhProteccionCivil Model
 *
 * @method \App\Model\Entity\ViewMrrhhProteccionCivil get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhProteccionCivil newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhProteccionCivil[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhProteccionCivil|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhProteccionCivil saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhProteccionCivil patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhProteccionCivil[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhProteccionCivil findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhProteccionCivilTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_proteccion_civil');
    }
