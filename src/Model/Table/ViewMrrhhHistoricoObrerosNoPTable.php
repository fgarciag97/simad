...
/**
 * ViewMrrhhHistoricoObrerosNoP Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosNoP get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosNoP newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosNoP[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosNoP|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosNoP saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosNoP patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosNoP[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosNoP findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoObrerosNoPTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_obreros_no_p');
    }
