...
/**
 * MrrhhHistoricoDirectivos Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoDirectivo get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoDirectivo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoDirectivo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoDirectivo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoDirectivo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoDirectivo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoDirectivo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoDirectivo findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoDirectivosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_directivos');
