...
/**
 * MrrhhHistoricoRetroactivoNominaam Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominaam get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominaam newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominaam[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominaam|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominaam saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominaam patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominaam[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominaam findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoRetroactivoNominaamTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_retroactivo_nominaam');
