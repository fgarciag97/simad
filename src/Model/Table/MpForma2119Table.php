 ...
 * MpForma2119 Model
 *
 * @method \App\Model\Entity\MpForma2119 get($primaryKey, $options = [])
 * @method \App\Model\Entity\MpForma2119 newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MpForma2119[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MpForma2119|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MpForma2119 saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MpForma2119 patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MpForma2119[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MpForma2119 findOrCreate($search, callable $callback = null, $options = [])
 */
class MpForma2119Table extends Table
{
    /**
     * Initialize method
     *
