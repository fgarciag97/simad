...
/**
 * MrrhhHistoricoRetroactivoNominabex Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominabex get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominabex newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominabex[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominabex|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominabex saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominabex patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominabex[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominabex findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoRetroactivoNominabexTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_retroactivo_nominabex');
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->decimal('porcentaje_aumneto')
            ->allowEmptyString('porcentaje_aumneto');
