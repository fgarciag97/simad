...
/**
 * ViewMrrhhObrerosContratadosAux Model
 *
 * @method \App\Model\Entity\ViewMrrhhObrerosContratadosAux get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosContratadosAux newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosContratadosAux[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosContratadosAux|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosContratadosAux saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosContratadosAux patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosContratadosAux[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosContratadosAux findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhObrerosContratadosAuxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_obreros_contratados_aux');
    }
