...
/**
 * MrrhhHistoricoBeObrerosFijos Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoBeObrerosFijo get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeObrerosFijo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeObrerosFijo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeObrerosFijo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeObrerosFijo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeObrerosFijo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeObrerosFijo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeObrerosFijo findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoBeObrerosFijosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_be_obreros_fijos');
