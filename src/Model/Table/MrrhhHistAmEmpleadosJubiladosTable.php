...
/**
 * MrrhhHistAmEmpleadosJubilados Model
 *
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosJubilado get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosJubilado newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosJubilado[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosJubilado|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosJubilado saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosJubilado patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosJubilado[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosJubilado findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistAmEmpleadosJubiladosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_hist_am_empleados_jubilados');
