...
/**
 * ViewMrrhhEmpleadosFijos Model
 *
 * @method \App\Model\Entity\ViewMrrhhEmpleadosFijo get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosFijo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosFijo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosFijo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosFijo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosFijo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosFijo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosFijo findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhEmpleadosFijosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_empleados_fijos');
    }
