...
/**
 * ViewMrrhhHistoricoObrerosC Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosC get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosC newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosC[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosC|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosC saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosC patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosC[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosC findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoObrerosCTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_obreros_c');
    }
