...
/**
 * ViewMrrhhHonorarioPAux Model
 *
 * @method \App\Model\Entity\ViewMrrhhHonorarioPAux get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHonorarioPAux newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHonorarioPAux[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHonorarioPAux|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHonorarioPAux saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHonorarioPAux patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHonorarioPAux[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHonorarioPAux findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHonorarioPAuxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_honorario_p_aux');
    }
