...
/**
 * MrrhhHistAmCementerio Model
 *
 * @method \App\Model\Entity\MrrhhHistAmCementerio get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmCementerio newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmCementerio[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmCementerio|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmCementerio saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmCementerio patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmCementerio[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmCementerio findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistAmCementerioTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_hist_am_cementerio');
