...
/**
 * MrrhhHistoricoRetroactivoNominax Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominax get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominax newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominax[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominax|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominax saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominax patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominax[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominax findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoRetroactivoNominaxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_retroactivo_nominax');
