...
/**
 * ViewMrrhhHistAmCementerio Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistAmCementerio get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmCementerio newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmCementerio[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmCementerio|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmCementerio saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmCementerio patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmCementerio[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmCementerio findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistAmCementerioTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_hist_am_cementerio');
    }
