...
/**
 * MrrhhHistAmObrerosNoPermanentes Model
 *
 * @method \App\Model\Entity\MrrhhHistAmObrerosNoPermanente get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmObrerosNoPermanente newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmObrerosNoPermanente[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmObrerosNoPermanente|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmObrerosNoPermanente saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmObrerosNoPermanente patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmObrerosNoPermanente[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmObrerosNoPermanente findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistAmObrerosNoPermanentesTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_hist_am_obreros_no_permanentes');
