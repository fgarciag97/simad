...
/**
 * ViewMrrhhHistoricoRetroactivoVx Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoRetroactivoVx get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoRetroactivoVx newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoRetroactivoVx[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoRetroactivoVx|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoRetroactivoVx saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoRetroactivoVx patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoRetroactivoVx[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoRetroactivoVx findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoRetroactivoVxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_retroactivo_vx');
    }
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->decimal('sueldo_anterior')
            ->allowEmptyString('sueldo_anterior');
