...
/**
 * MrrhhHistoricoAmProteccionCivil Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoAmProteccionCivil get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmProteccionCivil newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmProteccionCivil[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmProteccionCivil|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmProteccionCivil saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmProteccionCivil patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmProteccionCivil[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmProteccionCivil findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoAmProteccionCivilTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_am_proteccion_civil');
