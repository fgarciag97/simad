...
/**
 * ViewMrrhhHistBeDirectivos Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistBeDirectivo get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeDirectivo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeDirectivo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeDirectivo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeDirectivo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeDirectivo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeDirectivo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeDirectivo findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistBeDirectivosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_hist_be_directivos');
    }
