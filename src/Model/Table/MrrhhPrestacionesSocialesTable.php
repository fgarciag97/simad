...
/**
 * MrrhhPrestacionesSociales Model
 *
 * @method \App\Model\Entity\MrrhhPrestacionesSociale get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhPrestacionesSociale newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhPrestacionesSociale[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhPrestacionesSociale|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhPrestacionesSociale saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhPrestacionesSociale patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhPrestacionesSociale[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhPrestacionesSociale findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhPrestacionesSocialesTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_prestaciones_sociales');
