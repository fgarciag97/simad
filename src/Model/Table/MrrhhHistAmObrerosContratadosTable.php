...
/**
 * MrrhhHistAmObrerosContratados Model
 *
 * @method \App\Model\Entity\MrrhhHistAmObrerosContratado get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmObrerosContratado newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmObrerosContratado[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmObrerosContratado|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmObrerosContratado saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmObrerosContratado patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmObrerosContratado[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmObrerosContratado findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistAmObrerosContratadosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_hist_am_obreros_contratados');
