...
/**
 * MrrhhHistoricoRetroactivoNomina Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNomina get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNomina newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNomina[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNomina|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNomina saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNomina patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNomina[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNomina findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoRetroactivoNominaTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_retroactivo_nomina');
