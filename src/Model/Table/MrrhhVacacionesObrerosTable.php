...
/**
 * MrrhhVacacionesObreros Model
 *
 * @method \App\Model\Entity\MrrhhVacacionesObrero get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesObrero newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesObrero[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesObrero|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesObrero saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesObrero patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesObrero[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesObrero findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhVacacionesObrerosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_vacaciones_obreros');
