...
/**
 * ViewMrrhhPensionadosEmpleadosAux Model
 *
 * @method \App\Model\Entity\ViewMrrhhPensionadosEmpleadosAux get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPensionadosEmpleadosAux newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPensionadosEmpleadosAux[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPensionadosEmpleadosAux|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPensionadosEmpleadosAux saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPensionadosEmpleadosAux patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPensionadosEmpleadosAux[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPensionadosEmpleadosAux findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhPensionadosEmpleadosAuxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_pensionados_empleados_aux');
    }
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->decimal('x_aporte_patronal_afpj')
            ->allowEmptyString('x_aporte_patronal_afpj');
