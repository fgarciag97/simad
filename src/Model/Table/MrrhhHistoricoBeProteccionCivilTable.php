...
/**
 * MrrhhHistoricoBeProteccionCivil Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoBeProteccionCivil get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeProteccionCivil newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeProteccionCivil[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeProteccionCivil|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeProteccionCivil saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeProteccionCivil patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeProteccionCivil[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeProteccionCivil findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoBeProteccionCivilTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_be_proteccion_civil');
