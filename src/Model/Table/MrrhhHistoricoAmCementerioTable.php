...
/**
 * MrrhhHistoricoAmCementerio Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoAmCementerio get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmCementerio newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmCementerio[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmCementerio|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmCementerio saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmCementerio patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmCementerio[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmCementerio findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoAmCementerioTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_am_cementerio');
