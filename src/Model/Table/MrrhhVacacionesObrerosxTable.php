...
/**
 * MrrhhVacacionesObrerosx Model
 *
 * @method \App\Model\Entity\MrrhhVacacionesObrerosx get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesObrerosx newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesObrerosx[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesObrerosx|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesObrerosx saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesObrerosx patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesObrerosx[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesObrerosx findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhVacacionesObrerosxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_vacaciones_obrerosx');
