...
/**
 * ViewMrrhhPenEspEmpleadosAux Model
 *
 * @method \App\Model\Entity\ViewMrrhhPenEspEmpleadosAux get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspEmpleadosAux newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspEmpleadosAux[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspEmpleadosAux|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspEmpleadosAux saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspEmpleadosAux patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspEmpleadosAux[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspEmpleadosAux findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhPenEspEmpleadosAuxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_pen_esp_empleados_aux');
    }
