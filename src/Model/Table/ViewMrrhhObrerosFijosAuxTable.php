...
/**
 * ViewMrrhhObrerosFijosAux Model
 *
 * @method \App\Model\Entity\ViewMrrhhObrerosFijosAux get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosFijosAux newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosFijosAux[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosFijosAux|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosFijosAux saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosFijosAux patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosFijosAux[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosFijosAux findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhObrerosFijosAuxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_obreros_fijos_aux');
    }
