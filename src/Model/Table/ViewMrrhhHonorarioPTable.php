...
/**
 * ViewMrrhhHonorarioP Model
 *
 * @method \App\Model\Entity\ViewMrrhhHonorarioP get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHonorarioP newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHonorarioP[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHonorarioP|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHonorarioP saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHonorarioP patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHonorarioP[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHonorarioP findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHonorarioPTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_honorario_p');
    }
