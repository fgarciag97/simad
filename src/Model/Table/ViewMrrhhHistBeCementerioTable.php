...
/**
 * ViewMrrhhHistBeCementerio Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistBeCementerio get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeCementerio newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeCementerio[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeCementerio|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeCementerio saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeCementerio patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeCementerio[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeCementerio findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistBeCementerioTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_hist_be_cementerio');
    }
