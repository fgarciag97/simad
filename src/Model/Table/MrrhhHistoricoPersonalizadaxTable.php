...
/**
 * MrrhhHistoricoPersonalizadax Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizadax get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizadax newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizadax[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizadax|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizadax saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizadax patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizadax[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizadax findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoPersonalizadaxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_personalizadax');
