...
/**
 * ViewMrrhhComisionServicioAux Model
 *
 * @method \App\Model\Entity\ViewMrrhhComisionServicioAux get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhComisionServicioAux newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhComisionServicioAux[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhComisionServicioAux|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhComisionServicioAux saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhComisionServicioAux patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhComisionServicioAux[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhComisionServicioAux findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhComisionServicioAuxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_comision_servicio_aux');
    }
