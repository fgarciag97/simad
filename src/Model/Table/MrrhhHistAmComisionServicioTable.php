...
/**
 * MrrhhHistAmComisionServicio Model
 *
 * @method \App\Model\Entity\MrrhhHistAmComisionServicio get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmComisionServicio newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmComisionServicio[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmComisionServicio|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmComisionServicio saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmComisionServicio patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmComisionServicio[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmComisionServicio findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistAmComisionServicioTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_hist_am_comision_servicio');
