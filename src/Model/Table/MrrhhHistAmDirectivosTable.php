...
/**
 * MrrhhHistAmDirectivos Model
 *
 * @method \App\Model\Entity\MrrhhHistAmDirectivo get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmDirectivo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmDirectivo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmDirectivo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmDirectivo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmDirectivo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmDirectivo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmDirectivo findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistAmDirectivosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_hist_am_directivos');
