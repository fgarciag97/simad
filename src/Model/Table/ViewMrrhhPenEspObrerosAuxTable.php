...
/**
 * ViewMrrhhPenEspObrerosAux Model
 *
 * @method \App\Model\Entity\ViewMrrhhPenEspObrerosAux get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspObrerosAux newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspObrerosAux[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspObrerosAux|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspObrerosAux saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspObrerosAux patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspObrerosAux[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspObrerosAux findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhPenEspObrerosAuxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_pen_esp_obreros_aux');
    }
