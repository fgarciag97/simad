...
/**
 * ViewMrrhhHistAmObrerosFijos Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistAmObrerosFijo get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmObrerosFijo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmObrerosFijo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmObrerosFijo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmObrerosFijo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmObrerosFijo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmObrerosFijo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmObrerosFijo findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistAmObrerosFijosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_hist_am_obreros_fijos');
    }
