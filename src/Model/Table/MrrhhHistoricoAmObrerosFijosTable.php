...
/**
 * MrrhhHistoricoAmObrerosFijos Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoAmObrerosFijo get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmObrerosFijo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmObrerosFijo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmObrerosFijo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmObrerosFijo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmObrerosFijo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmObrerosFijo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmObrerosFijo findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoAmObrerosFijosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_am_obreros_fijos');
