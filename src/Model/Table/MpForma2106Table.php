 ...
 * MpForma2106 Model
 *
 * @method \App\Model\Entity\MpForma2106 get($primaryKey, $options = [])
 * @method \App\Model\Entity\MpForma2106 newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MpForma2106[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MpForma2106|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MpForma2106 saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MpForma2106 patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MpForma2106[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MpForma2106 findOrCreate($search, callable $callback = null, $options = [])
 */
class MpForma2106Table extends Table
{
    /**
     * Initialize method
     *
