 ...
 * MrrhhFinx Model
 *
 * @method \App\Model\Entity\MrrhhFinx get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhFinx newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhFinx[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhFinx|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhFinx saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhFinx patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhFinx[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhFinx findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhFinxTable extends Table
{
    /**
     * Initialize method
     *
