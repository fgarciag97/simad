...
/**
 * MrrhhHistoricoProteccionCivil Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoProteccionCivil get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoProteccionCivil newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoProteccionCivil[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoProteccionCivil|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoProteccionCivil saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoProteccionCivil patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoProteccionCivil[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoProteccionCivil findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoProteccionCivilTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_proteccion_civil');
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->boolean('bono_estabilidad')
            ->allowEmptyString('bono_estabilidad');

        $validator
            ->boolean('vacaciones')
            ->allowEmptyString('vacaciones');
