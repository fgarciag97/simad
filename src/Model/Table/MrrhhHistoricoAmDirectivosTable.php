...
/**
 * MrrhhHistoricoAmDirectivos Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoAmDirectivo get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmDirectivo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmDirectivo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmDirectivo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmDirectivo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmDirectivo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmDirectivo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmDirectivo findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoAmDirectivosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_am_directivos');
