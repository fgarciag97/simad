...
/**
 * ViewMrrhhHistoricoOPEsp Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoOPEsp get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoOPEsp newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoOPEsp[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoOPEsp|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoOPEsp saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoOPEsp patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoOPEsp[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoOPEsp findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoOPEspTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_o_p_esp');
    }
