...
/**
 * ViewMrrhhObrerosNoPermanentesAux Model
 *
 * @method \App\Model\Entity\ViewMrrhhObrerosNoPermanentesAux get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosNoPermanentesAux newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosNoPermanentesAux[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosNoPermanentesAux|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosNoPermanentesAux saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosNoPermanentesAux patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosNoPermanentesAux[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosNoPermanentesAux findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhObrerosNoPermanentesAuxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_obreros_no_permanentes_aux');
    }
