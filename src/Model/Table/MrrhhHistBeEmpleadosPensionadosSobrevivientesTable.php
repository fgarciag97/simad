...
/**
 * MrrhhHistBeEmpleadosPensionadosSobrevivientes Model
 *
 * @method \App\Model\Entity\MrrhhHistBeEmpleadosPensionadosSobreviviente get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeEmpleadosPensionadosSobreviviente newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeEmpleadosPensionadosSobreviviente[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeEmpleadosPensionadosSobreviviente|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeEmpleadosPensionadosSobreviviente saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeEmpleadosPensionadosSobreviviente patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeEmpleadosPensionadosSobreviviente[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeEmpleadosPensionadosSobreviviente findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistBeEmpleadosPensionadosSobrevivientesTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_hist_be_empleados_pensionados_sobrevivientes');
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->decimal('bono_dejado_c')
            ->allowEmptyString('bono_dejado_c');
