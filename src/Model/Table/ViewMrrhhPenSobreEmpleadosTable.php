...
/**
 * ViewMrrhhPenSobreEmpleados Model
 *
 * @method \App\Model\Entity\ViewMrrhhPenSobreEmpleado get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreEmpleado newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreEmpleado[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreEmpleado|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreEmpleado saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreEmpleado patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreEmpleado[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreEmpleado findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhPenSobreEmpleadosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_pen_sobre_empleados');
    }
