...
/**
 * MrrhhHistoricoAmEmpleadosFijos Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoAmEmpleadosFijo get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmEmpleadosFijo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmEmpleadosFijo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmEmpleadosFijo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmEmpleadosFijo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmEmpleadosFijo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmEmpleadosFijo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmEmpleadosFijo findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoAmEmpleadosFijosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_am_empleados_fijos');
