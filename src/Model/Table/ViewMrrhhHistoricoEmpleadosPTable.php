...
/**
 * ViewMrrhhHistoricoEmpleadosP Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosP get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosP newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosP[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosP|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosP saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosP patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosP[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosP findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoEmpleadosPTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_empleados_p');
    }
