...
/**
 * ViewMrrhhObrerosNoPermanentes Model
 *
 * @method \App\Model\Entity\ViewMrrhhObrerosNoPermanente get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosNoPermanente newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosNoPermanente[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosNoPermanente|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosNoPermanente saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosNoPermanente patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosNoPermanente[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosNoPermanente findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhObrerosNoPermanentesTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_obreros_no_permanentes');
    }
