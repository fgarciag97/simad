...
/**
 * ViewMrrhhJubiladosEmpleados Model
 *
 * @method \App\Model\Entity\ViewMrrhhJubiladosEmpleado get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosEmpleado newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosEmpleado[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosEmpleado|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosEmpleado saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosEmpleado patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosEmpleado[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosEmpleado findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhJubiladosEmpleadosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_jubilados_empleados');
    }
