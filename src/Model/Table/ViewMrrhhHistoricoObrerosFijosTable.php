...
/**
 * ViewMrrhhHistoricoObrerosFijos Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosFijo get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosFijo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosFijo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosFijo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosFijo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosFijo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosFijo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoObrerosFijo findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoObrerosFijosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_obreros_fijos');
    }
