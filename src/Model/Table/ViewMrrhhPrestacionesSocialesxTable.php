...
/**
 * ViewMrrhhPrestacionesSocialesx Model
 *
 * @method \App\Model\Entity\ViewMrrhhPrestacionesSocialesx get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPrestacionesSocialesx newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPrestacionesSocialesx[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPrestacionesSocialesx|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPrestacionesSocialesx saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPrestacionesSocialesx patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPrestacionesSocialesx[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPrestacionesSocialesx findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhPrestacionesSocialesxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_prestaciones_socialesx');
    }
