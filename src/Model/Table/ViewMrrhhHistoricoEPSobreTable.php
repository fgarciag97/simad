...
/**
 * ViewMrrhhHistoricoEPSobre Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoEPSobre get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEPSobre newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEPSobre[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEPSobre|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEPSobre saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEPSobre patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEPSobre[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEPSobre findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoEPSobreTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_e_p_sobre');
    }
