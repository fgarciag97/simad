...
/**
 * MrrhhHistoricoCementerio Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoCementerio get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoCementerio newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoCementerio[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoCementerio|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoCementerio saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoCementerio patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoCementerio[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoCementerio findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoCementerioTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_cementerio');
