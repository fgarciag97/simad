...
/**
 * ViewMrrhhPenEspObreros Model
 *
 * @method \App\Model\Entity\ViewMrrhhPenEspObrero get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspObrero newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspObrero[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspObrero|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspObrero saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspObrero patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspObrero[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspObrero findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhPenEspObrerosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_pen_esp_obreros');
    }
