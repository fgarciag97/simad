...
/**
 * MrrhhDirectivos Model
 *
 * @method \App\Model\Entity\MrrhhDirectivo get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhDirectivo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhDirectivo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhDirectivo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhDirectivo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhDirectivo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhDirectivo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhDirectivo findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhDirectivosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_directivos');
