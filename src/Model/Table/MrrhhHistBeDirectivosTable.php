...
/**
 * MrrhhHistBeDirectivos Model
 *
 * @method \App\Model\Entity\MrrhhHistBeDirectivo get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeDirectivo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeDirectivo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeDirectivo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeDirectivo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeDirectivo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeDirectivo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeDirectivo findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistBeDirectivosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_hist_be_directivos');
