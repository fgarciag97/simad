...
/**
 * ViewMrrhhVacacionesObreros Model
 *
 * @method \App\Model\Entity\ViewMrrhhVacacionesObrero get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesObrero newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesObrero[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesObrero|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesObrero saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesObrero patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesObrero[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesObrero findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhVacacionesObrerosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_vacaciones_obreros');
    }
