...
/**
 * ViewMrrhhPenEspEmpleados Model
 *
 * @method \App\Model\Entity\ViewMrrhhPenEspEmpleado get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspEmpleado newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspEmpleado[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspEmpleado|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspEmpleado saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspEmpleado patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspEmpleado[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenEspEmpleado findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhPenEspEmpleadosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_pen_esp_empleados');
    }
