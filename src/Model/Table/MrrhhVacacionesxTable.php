...
/**
 * MrrhhVacacionesx Model
 *
 * @method \App\Model\Entity\MrrhhVacacionesx get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesx newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesx[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesx|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesx saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesx patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesx[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhVacacionesx findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhVacacionesxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_vacacionesx');
