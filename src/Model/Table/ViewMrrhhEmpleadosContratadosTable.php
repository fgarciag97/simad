...
/**
 * ViewMrrhhEmpleadosContratados Model
 *
 * @method \App\Model\Entity\ViewMrrhhEmpleadosContratado get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosContratado newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosContratado[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosContratado|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosContratado saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosContratado patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosContratado[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosContratado findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhEmpleadosContratadosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_empleados_contratados');
    }
