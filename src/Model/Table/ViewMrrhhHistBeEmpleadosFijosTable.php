...
/**
 * ViewMrrhhHistBeEmpleadosFijos Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistBeEmpleadosFijo get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeEmpleadosFijo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeEmpleadosFijo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeEmpleadosFijo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeEmpleadosFijo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeEmpleadosFijo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeEmpleadosFijo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistBeEmpleadosFijo findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistBeEmpleadosFijosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_hist_be_empleados_fijos');
    }
