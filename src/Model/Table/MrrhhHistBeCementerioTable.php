...
/**
 * MrrhhHistBeCementerio Model
 *
 * @method \App\Model\Entity\MrrhhHistBeCementerio get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeCementerio newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeCementerio[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeCementerio|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeCementerio saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeCementerio patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeCementerio[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeCementerio findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistBeCementerioTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_hist_be_cementerio');
