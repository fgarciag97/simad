...
/**
 * ViewMrrhhVacacionesObrerosx Model
 *
 * @method \App\Model\Entity\ViewMrrhhVacacionesObrerosx get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesObrerosx newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesObrerosx[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesObrerosx|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesObrerosx saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesObrerosx patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesObrerosx[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesObrerosx findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhVacacionesObrerosxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_vacaciones_obrerosx');
    }
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->decimal('bono_vacacional')
            ->allowEmptyString('bono_vacacional');
        ...
        $validator
            ->date('fecha_desde')
            ->allowEmptyDate('fecha_desde');

        $validator
            ->date('fecha_hasta')
            ->allowEmptyDate('fecha_hasta');

        $validator
            ->date('fecha_reintegro')
            ->allowEmptyDate('fecha_reintegro');
        ...
        $validator
            ->integer('dias_d')
            ->allowEmptyString('dias_d');

        $validator
            ->integer('dias_bono')
            ->allowEmptyString('dias_bono');
