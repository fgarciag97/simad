...
/**
 * ViewMrrhhHistAmEmpleadosFijos Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistAmEmpleadosFijo get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmEmpleadosFijo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmEmpleadosFijo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmEmpleadosFijo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmEmpleadosFijo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmEmpleadosFijo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmEmpleadosFijo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistAmEmpleadosFijo findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistAmEmpleadosFijosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_hist_am_empleados_fijos');
    }
