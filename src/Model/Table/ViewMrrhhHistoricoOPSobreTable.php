...
/**
 * ViewMrrhhHistoricoOPSobre Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoOPSobre get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoOPSobre newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoOPSobre[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoOPSobre|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoOPSobre saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoOPSobre patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoOPSobre[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoOPSobre findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoOPSobreTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_o_p_sobre');
    }
