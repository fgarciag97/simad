...
/**
 * ViewMrrhhVacacionesx Model
 *
 * @method \App\Model\Entity\ViewMrrhhVacacionesx get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesx newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesx[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesx|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesx saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesx patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesx[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhVacacionesx findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhVacacionesxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_vacacionesx');
    }
