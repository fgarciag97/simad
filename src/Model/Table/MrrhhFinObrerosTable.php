...
/**
 * MrrhhFinObreros Model
 *
 * @method \App\Model\Entity\MrrhhFinObrero get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhFinObrero newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhFinObrero[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhFinObrero|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhFinObrero saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhFinObrero patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhFinObrero[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhFinObrero findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhFinObrerosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_fin_obreros');
