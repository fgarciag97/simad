...
/**
 * MrrhhHistoricoRetroactivoNominaamx Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominaamx get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominaamx newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominaamx[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominaamx|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominaamx saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominaamx patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominaamx[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoNominaamx findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoRetroactivoNominaamxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_retroactivo_nominaamx');
