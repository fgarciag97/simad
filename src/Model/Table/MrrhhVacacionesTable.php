...
/**
 * MrrhhVacaciones Model
 *
 * @method \App\Model\Entity\MrrhhVacacione get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhVacacione newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhVacacione[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhVacacione|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhVacacione saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhVacacione patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhVacacione[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhVacacione findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhVacacionesTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_vacaciones');
