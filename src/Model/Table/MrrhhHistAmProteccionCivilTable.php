...
/**
 * MrrhhHistAmProteccionCivil Model
 *
 * @method \App\Model\Entity\MrrhhHistAmProteccionCivil get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmProteccionCivil newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmProteccionCivil[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmProteccionCivil|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmProteccionCivil saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmProteccionCivil patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmProteccionCivil[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmProteccionCivil findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistAmProteccionCivilTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_hist_am_proteccion_civil');
