...
/**
 * MrrhhHistoricoAmObrerosNoPermanentes Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoAmObrerosNoPermanente get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmObrerosNoPermanente newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmObrerosNoPermanente[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmObrerosNoPermanente|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmObrerosNoPermanente saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmObrerosNoPermanente patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmObrerosNoPermanente[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoAmObrerosNoPermanente findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoAmObrerosNoPermanentesTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_am_obreros_no_permanentes');
