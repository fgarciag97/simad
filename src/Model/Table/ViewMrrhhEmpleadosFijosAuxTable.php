...
/**
 * ViewMrrhhEmpleadosFijosAux Model
 *
 * @method \App\Model\Entity\ViewMrrhhEmpleadosFijosAux get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosFijosAux newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosFijosAux[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosFijosAux|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosFijosAux saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosFijosAux patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosFijosAux[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosFijosAux findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhEmpleadosFijosAuxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_empleados_fijos_aux');
    }
