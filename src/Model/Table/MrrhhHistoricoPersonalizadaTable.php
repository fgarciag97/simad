...
/**
 * MrrhhHistoricoPersonalizada Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizada get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizada newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizada[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizada|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizada saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizada patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizada[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizada findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoPersonalizadaTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_personalizada');
