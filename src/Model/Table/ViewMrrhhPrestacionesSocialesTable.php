...
/**
 * ViewMrrhhPrestacionesSociales Model
 *
 * @method \App\Model\Entity\ViewMrrhhPrestacionesSociale get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPrestacionesSociale newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPrestacionesSociale[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPrestacionesSociale|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPrestacionesSociale saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPrestacionesSociale patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPrestacionesSociale[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPrestacionesSociale findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhPrestacionesSocialesTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_prestaciones_sociales');
    }
