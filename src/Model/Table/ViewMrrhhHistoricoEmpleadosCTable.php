...
/**
 * ViewMrrhhHistoricoEmpleadosC Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosC get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosC newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosC[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosC|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosC saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosC patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosC[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosC findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoEmpleadosCTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_empleados_c');
    }
