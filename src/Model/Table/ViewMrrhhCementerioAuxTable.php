...
/**
 * ViewMrrhhCementerioAux Model
 *
 * @method \App\Model\Entity\ViewMrrhhCementerioAux get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhCementerioAux newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhCementerioAux[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhCementerioAux|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhCementerioAux saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhCementerioAux patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhCementerioAux[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhCementerioAux findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhCementerioAuxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_cementerio_aux');
    }
