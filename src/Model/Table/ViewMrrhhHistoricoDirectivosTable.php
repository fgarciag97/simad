...
/**
 * ViewMrrhhHistoricoDirectivos Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoDirectivo get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoDirectivo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoDirectivo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoDirectivo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoDirectivo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoDirectivo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoDirectivo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoDirectivo findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoDirectivosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_directivos');
    }
