...
/**
 * ViewMrrhhDirectivos Model
 *
 * @method \App\Model\Entity\ViewMrrhhDirectivo get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhDirectivo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhDirectivo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhDirectivo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhDirectivo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhDirectivo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhDirectivo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhDirectivo findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhDirectivosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_directivos');
    }
