...
/**
 * MrrhhPrestacionesSocialesx Model
 *
 * @method \App\Model\Entity\MrrhhPrestacionesSocialesx get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhPrestacionesSocialesx newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhPrestacionesSocialesx[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhPrestacionesSocialesx|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhPrestacionesSocialesx saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhPrestacionesSocialesx patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhPrestacionesSocialesx[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhPrestacionesSocialesx findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhPrestacionesSocialesxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_prestaciones_socialesx');
