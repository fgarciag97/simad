...
/**
 * ViewMrrhhCementerio Model
 *
 * @method \App\Model\Entity\ViewMrrhhCementerio get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhCementerio newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhCementerio[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhCementerio|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhCementerio saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhCementerio patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhCementerio[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhCementerio findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhCementerioTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_cementerio');
    }
