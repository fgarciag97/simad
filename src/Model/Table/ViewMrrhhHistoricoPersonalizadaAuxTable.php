...
/**
 * ViewMrrhhHistoricoPersonalizadaAux Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizadaAux get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizadaAux newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizadaAux[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizadaAux|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizadaAux saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizadaAux patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizadaAux[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizadaAux findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoPersonalizadaAuxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_personalizada_aux');
    }
