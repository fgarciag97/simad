...
/**
 * MrrhhHistoricoObrerosFijos Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoObrerosFijo get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoObrerosFijo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoObrerosFijo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoObrerosFijo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoObrerosFijo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoObrerosFijo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoObrerosFijo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoObrerosFijo findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoObrerosFijosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_obreros_fijos');
