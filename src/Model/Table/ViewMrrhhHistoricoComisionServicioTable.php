...
/**
 * ViewMrrhhHistoricoComisionServicio Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoComisionServicio get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoComisionServicio newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoComisionServicio[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoComisionServicio|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoComisionServicio saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoComisionServicio patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoComisionServicio[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoComisionServicio findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoComisionServicioTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_comision_servicio');
    }
