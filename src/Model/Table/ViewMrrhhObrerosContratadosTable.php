...
/**
 * ViewMrrhhObrerosContratados Model
 *
 * @method \App\Model\Entity\ViewMrrhhObrerosContratado get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosContratado newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosContratado[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosContratado|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosContratado saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosContratado patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosContratado[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhObrerosContratado findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhObrerosContratadosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_obreros_contratados');
    }
