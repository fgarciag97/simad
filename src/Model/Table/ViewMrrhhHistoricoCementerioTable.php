...
/**
 * ViewMrrhhHistoricoCementerio Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoCementerio get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoCementerio newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoCementerio[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoCementerio|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoCementerio saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoCementerio patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoCementerio[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoCementerio findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoCementerioTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_cementerio');
    }
