...
/**
 * ViewMrrhhPenSobreEmpleadosAux Model
 *
 * @method \App\Model\Entity\ViewMrrhhPenSobreEmpleadosAux get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreEmpleadosAux newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreEmpleadosAux[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreEmpleadosAux|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreEmpleadosAux saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreEmpleadosAux patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreEmpleadosAux[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreEmpleadosAux findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhPenSobreEmpleadosAuxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_pen_sobre_empleados_aux');
    }
