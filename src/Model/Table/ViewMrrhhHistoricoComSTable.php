...
/**
 * ViewMrrhhHistoricoComS Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoCom get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoCom newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoCom[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoCom|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoCom saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoCom patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoCom[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoCom findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoComSTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_com_s');
    }
