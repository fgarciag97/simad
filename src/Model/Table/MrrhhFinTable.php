 ...
 * MrrhhFin Model
 *
 * @method \App\Model\Entity\MrrhhFin get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhFin newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhFin[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhFin|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhFin saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhFin patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhFin[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhFin findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhFinTable extends Table
{
    /**
     * Initialize method
     *
