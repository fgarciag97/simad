...
/**
 * ViewMrrhhEmpleadosContratadosAux Model
 *
 * @method \App\Model\Entity\ViewMrrhhEmpleadosContratadosAux get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosContratadosAux newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosContratadosAux[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosContratadosAux|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosContratadosAux saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosContratadosAux patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosContratadosAux[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhEmpleadosContratadosAux findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhEmpleadosContratadosAuxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_empleados_contratados_aux');
    }
