...
/**
 * MrrhhHistBeObrerosFijos Model
 *
 * @method \App\Model\Entity\MrrhhHistBeObrerosFijo get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeObrerosFijo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeObrerosFijo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeObrerosFijo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeObrerosFijo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeObrerosFijo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeObrerosFijo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeObrerosFijo findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistBeObrerosFijosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_hist_be_obreros_fijos');
