...
/**
 * MrrhhFinObrerosx Model
 *
 * @method \App\Model\Entity\MrrhhFinObrerosx get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhFinObrerosx newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhFinObrerosx[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhFinObrerosx|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhFinObrerosx saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhFinObrerosx patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhFinObrerosx[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhFinObrerosx findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhFinObrerosxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_fin_obrerosx');
