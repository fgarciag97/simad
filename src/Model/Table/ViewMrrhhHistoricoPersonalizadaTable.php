...
/**
 * ViewMrrhhHistoricoPersonalizada Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizada get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizada newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizada[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizada|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizada saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizada patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizada[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPersonalizada findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoPersonalizadaTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_personalizada');
    }
