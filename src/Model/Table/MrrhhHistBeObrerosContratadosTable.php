...
/**
 * MrrhhHistBeObrerosContratados Model
 *
 * @method \App\Model\Entity\MrrhhHistBeObrerosContratado get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeObrerosContratado newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeObrerosContratado[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeObrerosContratado|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeObrerosContratado saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeObrerosContratado patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeObrerosContratado[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeObrerosContratado findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistBeObrerosContratadosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_hist_be_obreros_contratados');
