...
/**
 * MrrhhHistoricoBeCementerio Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoBeCementerio get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeCementerio newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeCementerio[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeCementerio|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeCementerio saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeCementerio patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeCementerio[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeCementerio findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoBeCementerioTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_be_cementerio');
