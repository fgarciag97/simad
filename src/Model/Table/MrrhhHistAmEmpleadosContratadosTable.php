...
/**
 * MrrhhHistAmEmpleadosContratados Model
 *
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosContratado get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosContratado newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosContratado[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosContratado|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosContratado saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosContratado patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosContratado[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmEmpleadosContratado findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistAmEmpleadosContratadosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_hist_am_empleados_contratados');
