...
/**
 * ViewMrrhhPenSobreObreros Model
 *
 * @method \App\Model\Entity\ViewMrrhhPenSobreObrero get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreObrero newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreObrero[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreObrero|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreObrero saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreObrero patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreObrero[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPenSobreObrero findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhPenSobreObrerosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_pen_sobre_obreros');
    }
