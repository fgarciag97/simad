...
/**
 * MrrhhHistoricoPersonalizadaAux Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizadaAux get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizadaAux newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizadaAux[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizadaAux|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizadaAux saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizadaAux patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizadaAux[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoPersonalizadaAux findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoPersonalizadaAuxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_personalizada_aux');
