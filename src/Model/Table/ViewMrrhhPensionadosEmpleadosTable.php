...
/**
 * ViewMrrhhPensionadosEmpleados Model
 *
 * @method \App\Model\Entity\ViewMrrhhPensionadosEmpleado get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPensionadosEmpleado newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPensionadosEmpleado[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPensionadosEmpleado|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPensionadosEmpleado saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhPensionadosEmpleado patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPensionadosEmpleado[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhPensionadosEmpleado findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhPensionadosEmpleadosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_pensionados_empleados');
    }
