...
/**
 * ViewMrrhhJubiladosObrerosAux Model
 *
 * @method \App\Model\Entity\ViewMrrhhJubiladosObrerosAux get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosObrerosAux newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosObrerosAux[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosObrerosAux|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosObrerosAux saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosObrerosAux patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosObrerosAux[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhJubiladosObrerosAux findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhJubiladosObrerosAuxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_jubilados_obreros_aux');
    }
