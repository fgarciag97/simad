...
/**
 * MrrhhHistAmHonorarioProfesionales Model
 *
 * @method \App\Model\Entity\MrrhhHistAmHonorarioProfesionale get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmHonorarioProfesionale newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmHonorarioProfesionale[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmHonorarioProfesionale|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmHonorarioProfesionale saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistAmHonorarioProfesionale patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmHonorarioProfesionale[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistAmHonorarioProfesionale findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistAmHonorarioProfesionalesTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_hist_am_honorario_profesionales');
