...
/**
 * ViewMrrhhHistoricoPc Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoPc get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPc newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPc[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPc|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPc saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPc patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPc[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoPc findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoPcTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_pc');
    }
