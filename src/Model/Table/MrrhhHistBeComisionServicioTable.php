...
/**
 * MrrhhHistBeComisionServicio Model
 *
 * @method \App\Model\Entity\MrrhhHistBeComisionServicio get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeComisionServicio newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeComisionServicio[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeComisionServicio|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeComisionServicio saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeComisionServicio patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeComisionServicio[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeComisionServicio findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistBeComisionServicioTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_hist_be_comision_servicio');
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->decimal('bono_dias_cancelar')
            ->allowEmptyString('bono_dias_cancelar');
