...
/**
 * ViewMrrhhHistoricoHonorarioP Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoHonorarioP get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoHonorarioP newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoHonorarioP[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoHonorarioP|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoHonorarioP saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoHonorarioP patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoHonorarioP[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoHonorarioP findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoHonorarioPTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_honorario_p');
    }
