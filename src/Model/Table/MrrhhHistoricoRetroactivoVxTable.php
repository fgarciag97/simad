...
/**
 * MrrhhHistoricoRetroactivoVx Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoVx get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoVx newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoVx[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoVx|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoVx saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoVx patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoVx[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoRetroactivoVx findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoRetroactivoVxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_retroactivo_vx');
