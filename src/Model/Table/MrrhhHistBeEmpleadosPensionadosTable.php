...
/**
 * MrrhhHistBeEmpleadosPensionados Model
 *
 * @method \App\Model\Entity\MrrhhHistBeEmpleadosPensionado get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeEmpleadosPensionado newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeEmpleadosPensionado[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeEmpleadosPensionado|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeEmpleadosPensionado saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeEmpleadosPensionado patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeEmpleadosPensionado[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeEmpleadosPensionado findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistBeEmpleadosPensionadosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_hist_be_empleados_pensionados');
