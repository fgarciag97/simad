...
/**
 * MrrhhHistBeProteccionCivil Model
 *
 * @method \App\Model\Entity\MrrhhHistBeProteccionCivil get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeProteccionCivil newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeProteccionCivil[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeProteccionCivil|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeProteccionCivil saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistBeProteccionCivil patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeProteccionCivil[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistBeProteccionCivil findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistBeProteccionCivilTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_hist_be_proteccion_civil');
