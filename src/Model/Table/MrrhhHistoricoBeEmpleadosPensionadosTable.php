...
/**
 * MrrhhHistoricoBeEmpleadosPensionados Model
 *
 * @method \App\Model\Entity\MrrhhHistoricoBeEmpleadosPensionado get($primaryKey, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeEmpleadosPensionado newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeEmpleadosPensionado[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeEmpleadosPensionado|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeEmpleadosPensionado saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeEmpleadosPensionado patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeEmpleadosPensionado[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\MrrhhHistoricoBeEmpleadosPensionado findOrCreate($search, callable $callback = null, $options = [])
 */
class MrrhhHistoricoBeEmpleadosPensionadosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mrrhh_historico_be_empleados_pensionados');
