...
/**
 * ViewMrrhhDirectivosAux Model
 *
 * @method \App\Model\Entity\ViewMrrhhDirectivosAux get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhDirectivosAux newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhDirectivosAux[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhDirectivosAux|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhDirectivosAux saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhDirectivosAux patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhDirectivosAux[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhDirectivosAux findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhDirectivosAuxTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_directivos_aux');
    }
