...
/**
 * ViewMrrhhComisionServicio Model
 *
 * @method \App\Model\Entity\ViewMrrhhComisionServicio get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhComisionServicio newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhComisionServicio[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhComisionServicio|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhComisionServicio saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhComisionServicio patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhComisionServicio[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhComisionServicio findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhComisionServicioTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_comision_servicio');
    }
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->integer('grado_instruccion')
            ->allowEmptyString('grado_instruccion');
