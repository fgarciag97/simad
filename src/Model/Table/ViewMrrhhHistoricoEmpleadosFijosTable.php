...
/**
 * ViewMrrhhHistoricoEmpleadosFijos Model
 *
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosFijo get($primaryKey, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosFijo newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosFijo[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosFijo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosFijo saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosFijo patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosFijo[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\ViewMrrhhHistoricoEmpleadosFijo findOrCreate($search, callable $callback = null, $options = [])
 */
class ViewMrrhhHistoricoEmpleadosFijosTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('view_mrrhh_historico_empleados_fijos');
    }
