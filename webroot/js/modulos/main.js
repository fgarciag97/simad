$(document).ready(function() {
    ...
    $('.btn-search').on('click', function() {
        swal({
            ...
            html: '<div class="form-group label-floating">' + '<label class="control-label" for="InputSearch">write here</label>' + '<input class="form-control" id="InputSearch" type="text">' + '</div>'
        }).then(function() {
