...
$('document').ready(function(){
    $('.moneda').mask('000.000.000.000.000,00', {reverse: true});
});
...
function cargar_partidas_us(op){
        ...
        $.ajax({
            ...
            url: "/sisadmi/ajax/cargarpartidasus/" + op, //localhost
...
//Funcion para permitir solo numeros y puntos
function soloNum(e) {
...
function ver_nomina_editar(data){
    ...
    $('#form_editar').attr('action', '/sisadmi/m-r-r-h-h-nomina/asignardias');
...
function sueldo_individual(data){
    ...
    $('#form_sueldo_individual').attr('action', '/sisadmi/m-r-r-h-h-nomina/sueldoindividual');
...
function retroactivo_individual(data){
    ...
    $('#form_retroactivo_individual').attr('action', '/sisadmi/m-r-r-h-h-retroactivo/sueldoindividual');
...
function retroactivo_individual_v(data){
    ...
    $('#form_retroactivo_individual').attr('action', '/sisadmi/m-r-r-h-h-retroactivo-v/sueldoindividual');
...
function sueldo_individual_retro(data){
    ...
    $('#form_sueldo_individual').attr('action', '/sisadmi/m-r-r-h-h-retroactivo/sueldoindividual');
...
function sueldo_individual_retroam(data){
    ...
    $('#form_sueldo_individual').attr('action', '/sisadmi/m-r-r-h-h-retroactivo/sueldoindividualam');
...
function sueldo_individual_retrobe(data){
    ...
    $('#form_sueldo_individual').attr('action', '/sisadmi/m-r-r-h-h-retroactivo/sueldoindividualbe');
...
function editar_partida_rel(data){
    ...
    $('#editar_partida_relf').attr('action', '/sisadmi/mp-resolucion/editarpartidarel');
...
function ver_vacaciones_editar(data){
    ...
    /*$('#vdias_dejados_c').val($(data).attr('data-dias_dejados_c'));
    $('#vajuste_sueldo').val($(data).attr('data-ajuste_sueldo'));
    $('#vajuste_p_profesion').val($(data).attr('data-ajuste_p_profesion'));
    $('#vajuste_p_antiguedad').val($(data).attr('data-ajuste_p_antiguedad'));
    $('#vajuste_p_hijos').val($(data).attr('data-ajuste_p_hijos'));
    $('#vajuste_p_hogar').val($(data).attr('data-ajuste_p_hogar'));

    $('#vajuste_sso').val($(data).attr('data-ajuste_sso'));
    $('#vajuste_rpe').val($(data).attr('data-ajuste_rpe'));
    $('#vajuste_faov').val($(data).attr('data-ajuste_faov'));
    $('#vajuste_fpj').val($(data).attr('data-ajuste_fpj'));
    $('#vajuste_caja').val($(data).attr('data-ajuste_caja'));

    $('#vajuste_a_sso').val($(data).attr('data-ajuste_a_sso'));
    $('#vajuste_a_rpe').val($(data).attr('data-ajuste_a_rpe'));
    $('#vajuste_a_faov').val($(data).attr('data-ajuste_a_faov'));
    $('#vajuste_a_fpj').val($(data).attr('data-ajuste_a_fpj'));
    $('#vajuste_a_caja').val($(data).attr('data-ajuste_a_caja'));*/

    $('#vtpsn').val($(data).attr('data-tps'));
    $('#vmsn').val($(data).attr('data-ms'));

    $('#form_vaca').attr('action', '/sisadmi/m-r-r-h-h-vacaciones-o/asignardias');
...
function asignar_v(data){
    ...
    $('#form_v').attr('action', '/sisadmi/m-r-r-h-h-vacaciones/EditarV');
}
...
function asignar_f(data){
    ...
    $('#form_f').attr('action', '/sisadmi/m-r-r-h-h-fin/EditarF');
}
...
function ver_vacaciones_editar_obreros(data){
    ...
    $('#form_vaco').attr('action', '/sisadmi/m-r-r-h-h-vacaciones-o/asignardias');
...
function ver_fin_editar_obreros(data){
    ...
    $('#fo_form_fin').attr('action', '/sisadmi/m-r-r-h-h-fin-o/asignardias');
...
function modal_bono_editar(data){
    ...
    $('#form_editar_bono').attr('action', '/sisadmi/m-r-r-h-h-bono-estabilidad/asignarbono');
...
function modal_asistencia_editar(data){
    ...
    $('#form_editar_asistencia').attr('action', '/sisadmi/m-r-r-h-h-asistencia-medica/asignarasistencia');
...
function asignar_ps(data){
    ...
    $('#form_ps').attr('action', '/sisadmi/m-r-r-h-h-prestaciones-sociales/asignar');
}
...
function ajustar(data){
    ...
    $('#form_info').attr('action', '/sisadmi/mp-egresos/ajustar');
}
...
function incrementar(data){
    ...
    $('#form_incrementar').attr('action', '/sisadmi/mp-resolucion/incrementar');
}
...
function disminuir(data){
    ...
    $('#form_disminuir').attr('action', '/sisadmi/mp-resolucion/disminuir');
}
...
function asignar_ct_empleados(data){
    ...
    $('#form_info').attr('action', '/sisadmi/m-r-r-h-h-cesta-ticket-empleados/EditarCT');
}
...
function asignar_ct_cementerio(data){
    ...
    $('#form_info').attr('action', '/sisadmi/m-r-r-h-h-cesta-ticket-cementerio/EditarCT');
}
...
function asignar_ct_obreros(data){
    ...
    $('#form_info').attr('action', '/sisadmi/m-r-r-h-h-cesta-ticket-obreros/EditarCT');
}
...
function asignar_ct_proteccion_civil(data){
    ...
    $('#form_info').attr('action', '/sisadmi/m-r-r-h-h-cesta-ticket-proteccion-civil/EditarCT');
}
...
function asignar_he_empleados(data){
    ...
    $('#form_he').attr('action', '/sisadmi/m-r-r-h-h-horas-extras-empleados/EditarHE');
}
...
function ver_ultimo_ano(data){
    ...
    $('#ultimo_ano').attr('action', '/sisadmi/mrrhh-formulacion/editarultimoano');
}
...
function ver_ultimo_ano_empleados(data){
    ...
    $('#ultimo_ano_empleados').attr('action', '/sisadmi/mrrhh-formulacion/editarultimoanoempleados');
}
...
function asignar_he_obreros(data){
    ...
    $('#form_he').attr('action', '/sisadmi/m-r-r-h-h-horas-extras-obreros/EditarHE');
}
...
function asignar_he_proteccion_civil(data){
    ...
    $('#form_he').attr('action', '/sisadmi/m-r-r-h-h-horas-extras-proteccion-civil/EditarHE');
}
...
function numeroordennomina(data){
    ...
    $('#numeroorden').attr('action', '/sisadmi/m-ordenamiento/numeroordennomina');
}
...
function numeroordencompra(data){
    ...
    $('#numeroorden').attr('action', '/sisadmi/m-ordenamiento/numeroordencompra');
}
...
function numeroordenservicio(data){
    ...
    $('#numeroorden').attr('action', '/sisadmi/m-ordenamiento/numeroordenservicio');
}
...
function numeroordentransferencia(data){
    ...
    $('#numeroorden2').attr('action', '/sisadmi/m-ordenamiento/numeroordentransferencia');
}
//=========================================================================
...
$('document').ready(function(){
    ...
    function cargar_descripcion_partida(op){
        ...
        $.ajax({
            method: 'get',
            //url: "/ajax/descripcionpartida/" + op, //Servidor
            url: "/sisadmi/ajax/descripcionpartida/" + op, //localhost
    ...
    function cargar_programas(op){
        ...
        $.ajax({
            method: 'get',
            //url: "/ajax/programas/" + op, //Servidor
            url: "/sisadmi/ajax/programas/" + op, //localhost
    ...
    function cargar_denominacion_sector(op){
        ...
        $.ajax({
            method: 'get',
            //url: "/ajax/denominacionsector/" + op, //Servidor
            url: "/sisadmi/ajax/denominacionsector/" + op, //localhost
    ...
    function cargar_subprogramas(op){
        ...
        $.ajax({
            method: 'get',
            //url: "/ajax/subprogramas/" + op, //Servidor
            url: "/sisadmi/ajax/subprogramas/" + op, //localhost
    ...
    function cargar_denominacion_programa(op){
        ...
        $.ajax({
            method: 'get',
            //url: "/ajax/denominacionprograma/" + op, //Servidor
            url: "/sisadmi/ajax/denominacionprograma/" + op, //localhost
    ...
    function cargar_proyectos(op){
        ...
        $.ajax({
            method: 'get',
            //url: "/ajax/proyectos/" + op, //Servidor
            url: "/sisadmi/ajax/proyectos/" + op, //localhost
    ...
    function cargar_actividad(op){
        ...
        $.ajax({
            method: 'get',
            //url: "/ajax/actividades/" + op, //Servidor
            url: "/sisadmi/ajax/actividades/" + op, //localhost
    ...
    function cargar_denominacion_subprograma(op){
        ...
        $.ajax({
            method: 'get',
            //url: "/ajax/denominacionproyecto/" + op, //Servidor
            url: "/sisadmi/ajax/denominacionsubprograma/" + op, //localhost
    ...
    function cargar_denominacion_proyecto(op){
        ...
        $.ajax({
            method: 'get',
            //url: "/ajax/denominacionproyecto/" + op, //Servidor
            url: "/sisadmi/ajax/denominacionproyecto/" + op, //localhost
    ...
    function cargar_denominacion_actividad(op){
        ...
        $.ajax({
            method: 'get',
            //url: "/ajax/denominacionactividad/" + op, //Servidor
            url: "/sisadmi/ajax/denominacionactividad/" + op, //localhost
    ...
    function cargar_denominacion_partida(op){
        ...
        $.ajax({
            method: 'get',
            //url: "/ajax/denominacionpartida/" + op, //Servidor
            url: "/sisadmi/ajax/denominacionpartida/" + op, //localhost
    ...
    function ultimo_sueldo(op, d, h){
        ...
        $.ajax({
            method: 'get',
            //url: "/ajax/denominacionpartida/" + op, //Servidor
            url: "/sisadmi/ajax/ultimosueldo/" + op + "/" + d + "/" + h, //localhost
...
$('document').ready(function(){
    ...
    function cargar_tipo_personal(op){
        ...
        $.ajax({
            ...
            url: "/sisadmi/ajax/tipopersonal/" + op, //localhost
...
$('document').ready(function(){
    ...
    function cargar_cargos(op){
        ...
        $.ajax({
            ...
            url: "/sisadmi/ajax/cargos/" + op, //localhost
    ...
    function cargar_grupos(op){
        ...
        $.ajax({
            ...
            url: "/sisadmi/ajax/grupos/" + op, //localhost
    ...
    function cargar_nivel(op){
        ...
        $.ajax({
            ...
            url: "/sisadmi/ajax/nivel/" + op, //localhost
    ...
    function cargar_grado_nivel(op){
        ...
        $.ajax({
            ...
            url: "/sisadmi/ajax/gradonivel/" + op, //localhost
...
function editar_orden_compra(data){
    ...
    $('#form_compra').attr('action', '/sisadmi/m-compra-ordenes-emitidas/EditarOrden');
}
...
function editar_orden_servicio(data){
    ...
    $('#form_servicio').attr('action', '/sisadmi/m-compra-ordenes-servicio/EditarOrden');
}
...
function editar_orden_trans(data){
    ...
    $('#id_orden3').val($(data).attr('id_orden'));
    $('#requisicion3').val($(data).attr('req'));
    $('#form_trans').attr('action', '/sisadmi/ejecucion-transferencia/EditarOrden');
}
...
function editar_item_compra(data){
    ...
    $('#form_info').attr('action', '/sisadmi/m-compra-ordenes-emitidas/EditarCompra');
}
...
function editar_partida_trans(data){
    ...
    $('#unidad_medida2').val($(data).attr('data-unidad_medida'));
    $('#precio_unitario2').val($(data).attr('data-precio_unitario'));
    $('#form_trans2').attr('action', '/sisadmi/ejecucion-transferencia/editar');
}
...
function editar_item_servicio(data){
    ...
    $('#form_info222').attr('action', '/sisadmi/m-compra-ordenes-servicio/EditarServicio');
}
...
function editar_tabulacion_empleados(data){
    ...
    $('#form_info').attr('action', '/sisadmi/m-u-g-m-r-r-h-h-tabulacion-salarial/EditarTabulacionEmpleados');
}
...
function editar_tabulacion_rotativo(data){
    ...
    $('#id').val($(data).attr('data-id'));
    $('#sueldo_base').val($(data).attr('data-sueldobase'));
    $('#form_info').attr('action', '/sisadmi/m-u-g-m-r-r-h-h-tabulacion-salarial/EditarTabulacionRotativo');
}
...
function editar_ingreso(data){
    ...
    $('#ingreso').attr('action', '/sisadmi/ingresos/editar');
}
...
function editar_egreso(data){
    ...
    $('#id_sub_programae').val($(data).attr('data-id_sub_programa'));
    $('#egreso').attr('action', '/sisadmi/mp-proyectos/editaregresos');
}
...
function editar_tabulacion_directivos(data){
    ...
    $('#id').val($(data).attr('data-id'));
    $('#sueldo_base').val($(data).attr('data-sueldobase'));
    $('#form_info').attr('action', '/sisadmi/m-u-g-m-r-r-h-h-tabulacion-salarial/EditarTabulacionDirectivos');
}
...
function editar_tabulacion_obreros(data){
    ...
    $('#id').val($(data).attr('data-id'));
    $('#sueldo_base').val($(data).attr('data-sueldobase'));
    $('#form_info').attr('action', '/sisadmi/m-u-g-m-r-r-h-h-tabulacion-salarial/EditarTabulacionObreros');
}
...
function editar_tabulacion_obreros_no_permanentes(data){
    ...
    $('#id').val($(data).attr('data-id'));
    $('#sueldo_base').val($(data).attr('data-sueldobase'));
    $('#form_info').attr('action', '/sisadmi/m-u-g-m-r-r-h-h-tabulacion-salarial/EditarTabulacionObrerosNoPermanentes');
}
...
function editar_tabulacion_proteccion_civil(data){
    ...
    $('#id').val($(data).attr('data-id'));
    $('#sueldo_base').val($(data).attr('data-sueldobase'));
    $('#form_info').attr('action', '/sisadmi/m-u-g-m-r-r-h-h-tabulacion-salarial/EditarTabulacionProteccionCivil');
}
//=========================================================================
...
function editar_tabulacion_primas(data){
    ...
    $('#valor').attr('action', '/sisadmi/m-u-g-m-r-r-h-h-tabulacion-salarial/parametrosprimas');
}
//=========================================================================
...
function parametrosparametros(data){
    ...
    $('#parametros').attr('action', '/sisadmi/m-u-g-m-r-r-h-h-tabulacion-salarial/parametrosparametros');
}
//=========================================================================
...
function parametrosprofesion(data){
    ...
    $('#profesion').attr('action', '/sisadmi/m-u-g-m-r-r-h-h-tabulacion-salarial/parametrosprofesion');
}
...
//???????????????????????????????????
    function cargar_ramo(){
        $.ajax({
            ...
            url: "/sisadmi/ajax/ramo/", //localhost
    ...
    function cargar_ramo_egreso(){
        $.ajax({
            method: 'get',
            //url: "/ajax/ramo/" + op, //Servidor
            url: "/sisadmi/ajax/ramoegreso/", //localhost
...
$('document').ready(function(){
    ...
    function cargar_denominacion_ramo(op){
        ...
        $.ajax({
            ...
            url: "/sisadmi/ajax/denominacionramo/" + op, //localhost
    ...
    function cargar_subramo(op){
        ...
        $.ajax({
            ...
            url: "/sisadmi/ajax/subramo/" + op, //localhost
    ...
    function cargar_denominacion_subramo(op){
        ...
        $.ajax({
            ...
            url: "/sisadmi/ajax/denominacionsubramo/" + op, //localhost
    ...
    function cargar_especifico(op){
        ...
        $.ajax({
            ...
            url: "/sisadmi/ajax/especifico/" + op, //localhost
    ...
    function cargar_denominacion_especifico(op){
        ...
        $.ajax({
            ...
            url: "/sisadmi/ajax/denominacionespecifico/" + op, //localhost
    ...
    function cargar_subespecifico(op){
        ...
        $.ajax({
            ...
            url: "/sisadmi/ajax/subespecifico/" + op, //localhost
    ...
    function cargar_denominacion_subespecifico(op){
        ...
        $.ajax({
            ...
            url: "/sisadmi/ajax/denominacionsubespecifico/" + op, //localhost

            success: function(response){
                if(response[0][0]['descripcion'] == null){
                }else{
                    $("#denominacion").val(response[0][0]['descripcion']);
                }
            }
    ...
    function cargar_disponibilidad(op, s, p, a){
        ...
        $.ajax({
            method: 'get',
            //url: "/ajax/descripcionpartida2102/" + op, //Servidor
            url: "/sisadmi/ajax/disponibilidadpartidaegreso/" + op + "/" + s + "/" + p + "/" + a, //localhost 
    ...
    function cargar_descripcion_partida2102(op){
        ...
        $.ajax({
            method: 'get',
            //url: "/ajax/descripcionpartida2102/" + op, //Servidor
            url: "/sisadmi/ajax/descripcionpartida2102/" + op, //localhost
    ...
    function carga_calculo(req, op){
        ...
        $.ajax({
            ...
            url: "/sisadmi/ajax/deducciones/" + req + "/" + op, //localhost
    ...
    function credito(){
        ...
        $.ajax({
            method: 'get',
            //url: "/ajax/descripcionpartida2102/" + op, //Servidor
            url: "/sisadmi/ajax/credito/", //localhost
    ...
    function credito2(){
        ...
        $.ajax({
            method: 'get',
            //url: "/ajax/descripcionpartida2102/" + op, //Servidor
            url: "/sisadmi/ajax/credito2/", //localhost
    ...
    function datos_cuenta(){
        ...
        $.ajax({
            method: 'get',
            //url: "/ajax/descripcionpartida2102/" + op, //Servidor
            url: "/sisadmi/ajax/datoscuenta/", //localhost
    ...
    function cargar_cuenta(op){
        ...
        $.ajax({
            ...
            url: "/sisadmi/ajax/cargarcuenta/" + op, //localhost
    ...
    function cargar_cuenta_credito(op){
        ...
        $.ajax({
            method: 'get',
            //url: "/ajax/cargarcuenta/" + op, //Servidor
            url: "/sisadmi/ajax/cargarcuentacredito/" + op, //localhost
    ...
    function basei(req){
        ...
        $.ajax({
            method: 'get',
            //url: "/ajax/baseimponible/" + req, //Servidor
            url: "/sisadmi/ajax/baseimponible/" + req, //localhost
    ...
    function inpuesto(req){
        ...
        $.ajax({
            ...
            url: "/sisadmi/ajax/inpuesto/" + req, //localhost
    ...
    function nomina(op){
        ...
        $.ajax({
            method: 'get',
            //url: "/ajax/baseimponible/" + req, //Servidor
            url: "/sisadmi/ajax/datosnomina/" + op, //localhost
