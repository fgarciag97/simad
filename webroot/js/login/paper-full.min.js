var paper = function(t, e) {
            ...
            function t(t, e, r, s, a) {
                function u(i, u) {
                    ...
                    a && _ || (f && _ && (u.base = _), f && !1 !== s && (c = i.match(/^([gs]et|is)(([A-Z])(.*))$/)) && (l[c[3].toLowerCase() + c[4]] = c[2]), d && !f && d.get && "function" == typeof d.get && n.isPlainObject(d) || (d = {
                        ...
                        configurable: !0
                    }).configurable && (d.configurable = !0, d.enumerable = null != r ? r : !c), h(t, i, d))
                }
                var l = {};
                if (e) {
        ...
        w = r.extend(s, {
            ...
            statics: {
                ...
                _getBounds: function(t, e, n) {
                    ...
                    return {
                        rect: isFinite(i) ? new g(i, s, r - i, a - s) : new g,
                        nonscaling: o
                    }
                }
            }
            ...
            _hitTest: function(t, e, n) {
                ...
                if (f && this._parent && (v || p || m)) {
                    if ((p || m) && (l = this.getInternalBounds()), !(c = v && s("position") || p && s("center", "Center")) && m)
        ...
        T = r.extend({
            ...
            function t(t, e, n, i, r, s, a) {
                ...
                if (null !== i && i >= (o ? 1e-8 : 0) && i <= (h ? 1 - 1e-8 : 1) && null !== s && s >= (h ? 1e-8 : 0) && s <= (o ? 1 - 1e-8 : 1)) {
                    var u = new z(n, i, null, a),
                        l = new z(r, s, null, a);
                    u._intersection = l, l._intersection = u, e && !e(u) || z.insert(t, u, !0)
                }
            }
                ...
                if (Math.max(v - g, D - F) < 1e-9) {
                    ...
                    if (D - F > v - g) {
                        var V = T.subdivide(r, .5),
                            R = (F + D) / 2;
                        f = e(s, V[0], o, a, h, u, !l, c, f, g, v, F, R), f = e(s, V[1], o, a, h, u, !l, c, f, g, v, R, D)
                    } else {
                        var V = T.subdivide(s, .5),
                            q = (g + v) / 2;
                        f = e(V[0], r, o, a, h, u, !l, c, f, g, q, F, D), f = e(V[1], r, o, a, h, u, !l, c, f, q, v, F, D)
                    }
                else f = v - g >= 1e-9 ? e(s, r, o, a, h, u, !l, c, f, g, v, F, D) : e(r, s, a, o, h, u, l, c, f, F, D, g, v);
                return f
            }
            ...
            function h(n, i, r, s, h, u) {
                var l = Math.min,
                    f = Math.max;
                if (f(n[0], n[2], n[4], n[6]) + 1e-12 > l(i[0], i[2], i[4], i[6]) && l(n[0], n[2], n[4], n[6]) - 1e-12 < f(i[0], i[2], i[4], i[6]) && f(n[1], n[3], n[5], n[7]) + 1e-12 > l(i[1], i[3], i[5], i[7]) && l(n[1], n[3], n[5], n[7]) - 1e-12 < f(i[1], i[3], i[5], i[7])) {
                    var _ = d(n, i);
                    if (_)
                        for (var g = 0; g < 2; g++) {
                            var v = _[g];
                            ...
                            var p = T.isStraight(n),
                                m = T.isStraight(i),
                                y = p && m,
                                w = p && !m,
                                x = h.length;
                            if ((y ? o : p || m ? a : e)(w ? i : n, w ? n : i, w ? s : r, w ? r : s, h, u, w, 0, 0, 0, 1, 0, 1), !y || h.length === x)
                                for (var g = 0; g < 4; g++) {
                                    var b = g >> 1,
                                        C = 1 & g,
                                        S = 6 * b,
                                        ...
                                        I = new c(n[S], n[S + 1]),
                                        P = new c(i[k], i[k + 1]);
                                    I.isClose(P, 1e-12) && t(h, u, r, b, s, C)
                                }
                        }
                }
                return h
        ...
        L = O.extend({
            ...
            toShape: function(t) {
                ...
                if (!this.hasHandles() && 4 === l.length && n(0, 2) && n(1, 3) && function(t) {
                    ...
                    }(1) ? (s = C.Rectangle, a = new d(r(0, 3), r(0, 1)), h = l[1]._point.add(l[2]._point).divide(2)) : 8 === l.length && i(0) && i(2) && i(4) && i(6) && n(1, 5) && n(3, 7) ? (s = C.Rectangle, a = new d(r(1, 6), r(0, 3)), o = a.subtract(new d(r(0, 7), r(1, 2))).divide(2), h = l[3]._point.add(l[4]._point).divide(2)) : 4 === l.length && i(0) && i(1) && i(2) && i(3) && (u.isZero(r(0, 2) - r(1, 3)) ? (s = C.Circle, o = r(0, 2) / 2) : (s = C.Ellipse, o = new d(r(2, 0) / 2, r(3, 1) / 2)), h = l[1]._point), s) {
            ...
            compare: function t(e) {
                ...
                for (var g, v = Math.abs, d = u[a]; h && d;) {
                    ...
                    if (_) {
                        if (v(_[0][0] - c) < 1e-8) {
                            c = _[1][0], 1 === c && (h = ++l < r ? n[l].getValues() : null, c = 0);
                            var p = _[0][1];
                            if (v(p - o) < 1e-8) {
            ...
            return {
                ...
                arcTo: function() {
                    ...
                    for (var R = o(i), q = R >= 360 ? 4 : Math.ceil((R - 1e-7) / 90), V = i / q, U = V * Math.PI / 360, H = 4 / 3 * Math.sin(U) / (1 + Math.cos(U)), Z = [], W = 0; W <= q; W++) {
                        var S = _,
                            $ = null;
                        if (W < q && ($ = s.rotate(90).multiply(H), a ? (S = a._transformPoint(s), $ = a._transformPoint(s.add($)).subtract(S)) : S = n.add(s)), W) {
                            var G = s.rotate(-90).multiply(H);
    ...
    O.inject(new function() {
        ...
        function c(t, e, n, i, r) {
            function s(s) {
                ...
                if (!(p < _(a, h) || p > g(a, h))) {
                    var f = s[u + 0],
                        ...
                        x = s[u + 4],
                        b = s[u + 6];
                    if (a === h) return void((f < w && b > y || b < w && f > y) && (k = !0));
                    var I = p === a ? 0 : p === h ? 1 : y > g(f, v, x, b) || w < _(f, v, x, b) ? 1 : T.solveCubic(s, l, p, A, 0, 1) > 0 ? A[0] : 1,
                        M = 0 === I ? f : 1 === I ? b : T.getPoint(s, I)[n ? "y" : "x"],
                        z = a > h ? 1 : -1,
                        O = o[l] > o[l + 6] ? 1 : -1,
                        L = o[u + 6];
                    return p !== a ? (M < y ? C += z : M > w ? S += z : k = !0, M > d - m && M < d + m && (P /= 2)) : (z !== O ? f < y ? C += z : f > w && (S += z) : f != L && (L < w && M > w ? (S += z, k = !0) : L > y && M < y && (C += z, k = !0)), P = 0), o = s, !r && M > y && M < w && 0 === T.getTangent(s, I)[n ? "x" : "y"] && c(t, e, !n, i, !0)
                }
            }
            ...
            for (var o, h, u = n ? 1 : 0, l = 1 ^ u, f = [t.x, t.y], d = f[u], p = f[l], m = 1e-6, y = d - 1e-9, w = d + 1e-9, x = 0, b = 0, C = 0, S = 0, k = !1, I = !1, P = 1, A = [], M = 0, z = e.length; M < z; M++) {
                var O, L = e[M],
                    E = L._path,
                    N = L.getValues();
                if (!(M && e[M - 1]._path === E || (o = null, E._closed || (h = T.getValues(E.getLastCurve().getSegment2(), L.getSegment1(), null, !i), h[l] !== h[l + 6] && (o = h)), o))) {
                    o = N;
                    for (var B = E.getLastCurve(); B && B !== L;) {
                        var j = B.getValues();
                        if (j[l] !== j[l + 6]) {
                            o = j;
                            break
                ...
                if (O = a(N)) return O;
                if (M + 1 === z || e[M + 1]._path !== E) {
                    if (h && (O = a(h))) return O;
                    !k || C || S || (C = S = E.isClockwise(i) ^ n ? 1 : -1), x += C, b += S, C = S = 0, k && (I = !0, k = !1), h = null
                }
            }
            return x = v(x), b = v(b), {
                winding: g(x, b),
        ...
        function f(t, e, n, i, r) {
            ...
            for (var d = [.5, .25, .75], s = {
                    winding: 0,
                    quality: -1
                }, _ = 0; _ < d.length && s.quality < .5; _++)
                for (var f = h * d[_], g = 0, p = a.length; g < p; g++) {
                    var m = a[g],
                        y = m.length;
                    if (f <= y) {
                        var l = m.curve,
                            ...
                            k = v(l.getTangentAtTime(C).y) < Math.SQRT1_2,
                            I = r.subtract && n && (b === e && n._getWinding(S, k, !0).winding || b === n && !e._getWinding(S, k, !0).winding) ? {
                                winding: 0,
                                quality: 1
                            } : c(S, i, k, !0);
            ...
            for (var g = a.length - 1; g >= 0; g--) a[g].segment._winding = s
        }
                ...
                initialize: function e(n) {
                    ...
                    if ("string" === d && n in i && (a = n, n = l[1], Array.isArray(n) ? (o = n, h = l[2]) : (c && (f = 1), l = r.slice(l, 1), d = typeof n)), !o) {
                        if (u = "number" === d ? l : "object" === d && null != n.length ? n : null) {
                            ...
                            } else if (n.constructor === R) a = "gradient", u = l;
                        else {
                            ...
                            for (var g = 0, v = m.length; g < v; g++) {
                                ...
                                null == w && !g && "gradient" === a && "stops" in n && (w = {
                                    stops: n.stops,
                                    radial: n.radial
                                }), w = y[g].call(this, w), null != w && (o[g] = w)
                            }
                            h = n.alpha
                        }
                        c && a && (f = 1)
    ...
    H.requestAnimationFrame = new function() {
        ...
        var e, i = U.getPrefixed(n, "requestAnimationFrame"),
            r = !1,
            s = [];
        return function(n) {
    ...
    var Z = r.extend(s, {
            ...
            initialize: function t(e, r) {
                ...
                var h;
                if (n && r) {
                    this._id = r.getAttribute("id"), null == this._id && r.setAttribute("id", this._id = "view-" + t._id++), H.add(r, this._viewEvents);
                    if (U.setPrefixed(r.style, {
                            userDrag: "none",
                            userSelect: "none",
                            touchCallout: "none",
                            contentZooming: "none",
    ...
    return new function() {
        ...
        function x(e, n) {
            ...
            if (k) {
                ...
                for (var s in k.svgs) r || (i || (i = nt.create("svg"), i.appendChild(e)), r = i.insertBefore(nt.create("defs"), i.firstChild)),
        ...
        function _(t, e) {
            ...
            return r ? (f = a(t, "cx", "cy", !1, g), d = f.add(s(t, "r", !1, !1, g), 0), _ = a(t, "fx", "fy", !0, g)) : (f = a(t, "x1", "y1", !1, g), d = a(t, "x2", "y2", !1, g)), k(new D(n, f, d, _), t)._scaleToBounds = g, null
        }
        ...
        function k(t, n, i) {
            if (n.style) {
                var s = n.parentNode,
                    a = {
                        node: U.getStyles(n) || {},
                        parent: !i && !/^defs$/i.test(s.tagName) && U.getStyles(s) || {}
                    };
        ...
        function A(t, e, n) {
            var s, a, h, u = t.nodeName.toLowerCase(),
                l = "#document" !== u,
                c = i.body;
            n && l && (T = paper.getView().getSize(), T = o(t, null, null, !0) || T, s = nt.create("svg", {
        ...
        function h(r, s) {
            ...
            function u(t, e) {
                for (var n = a(t.range[0]), i = a(t.range[1]), s = 0, o = f.length - 1; o >= 0; o--)
                    if (n > f[o][0]) {
                        s = o + 1;
                        break
                    }
                f.splice(s, 0, [n, e.length - i + n]), r = r.substring(0, n) + e + r.substring(i)
            }
            ...
            var c, f = [],
                ...
                m = s.source || r,
                x = s.offset || 0;
            if (p && (_.chrome && g >= 30 || _.webkit && g >= 537.76 || _.firefox && g >= 23 || _.node)) {
                if (_.node) x -= 2;
                else if (n && d && !n.location.href.indexOf(d)) {
                    var b = i.getElementsByTagName("html")[0].innerHTML;
                    x = b.substr(0, b.indexOf(r) + 1).match(/\r\n|\n|\r/gm).length + 1
                }
        ...
        if (!v) {
            ...
            v = p = m = {},
                function(t, e) {
                    "object" == typeof p && "object" == typeof m ? e(p) : "function" == typeof define && define.amd ? define(["exports"], e) : e(t.acorn || (t.acorn = {}))
                }(this, function(t) {
                    "use strict";
                    ...
                    function H() {
                        ...
                        switch (t) {
                            ...
                            case Zt:
                                return M(), zt.push(Ye), e.body = H(), zt.pop(), R(ne), e.test = Z(), D(), N(e, "DoWhileStatement");
                            case Gt:
                                if (M(), zt.push(Ye), R(ge), bt === me) return $(e, null);
                                if (bt === ee) {
                                    var a = L();
                            ...
                            case Yt:
                                M(), e.discriminant = Z(), e.cases = [], R(de), zt.push(Qe);
                                for (var o, h; bt != _e;)
                                    if (bt === Rt || bt === Ht) {
                                        var u = bt === Rt;
                            ...
                            case Qt:
                                return M(), Ge.test(ft.slice(At, mt)) && n(At, "Illegal newline after throw"), e.argument = X(), D(), N(e, "ThrowStatement");
                            case te:
                            ...
                            case ne:
                                return M(), e.test = Z(), zt.push(Ye), e.body = H(), zt.pop(), N(e, "WhileStatement");
                            case ie:
                    ...
                    function tt(t, e, n) {
                        ...
                        if (null != i && (!n || bt !== ue) && i > e) {
                            ...
                            var s = bt;
                            M(), r.right = tt(et(), i, n);
                            return tt(N(r, s === Pe || s === Ae ? "LogicalExpression" : "BinaryExpression"), e, n)
                        }
                        return t
                    }
                    ...
                    function at() {
                        ...
                        for (t.properties = [], M(); !j(_e);) {
                            if (e) e = !1;
                            else if (R(pe), ct.allowTrailingCommas && j(_e)) break;
                            var r, s = {
                                    key: ot()
                                },
                                a = !1;
                    ...
                    function ut(t, e, n) {
                        for (var i = [], r = !0; !j(t);) {
                            if (r) r = !1;
                            else if (R(pe), e && ct.allowTrailingCommas && j(t)) break;
                    ...
                    function lt(t) {
                        var e = L();
                        return t && "everywhere" == ct.forbidReserved && (t = !1), bt === jt ? (!t && (ct.forbidReserved && (3 === ct.ecmaVersion ? De : Re)(Ct) || Ot && qe(Ct)) && -1 == ft.slice(mt, yt).indexOf("\\") && n(mt, "The keyword '" + Ct + "' is reserved"), e.name = Ct) : t && bt.keyword ? e.name = bt.keyword : q(), St = !1, M(), N(e, "Identifier")
                    }
                    t.version = "0.5.0";
                    var ct, ft, dt, _t;
                    ...
                    var Fe, De = i("abstract boolean byte char class double enum export extends final float goto implements import int interface long native package private protected public short static super synchronized throws transient volatile"),
                        ...
                        We = new RegExp("[" + Ze + "]"),
                        $e = new RegExp("[" + Ze + "̀-ͯ҃-֑҇-ׇֽֿׁׂׅׄؐ-ؚؠ-ىٲ-ۓۧ-ۨۻ-ۼܰ-݊ࠀ-ࠔࠛ-ࠣࠥ-ࠧࠩ-࠭ࡀ-ࡗࣤ-ࣾऀ-ःऺ-़ा-ॏ॑-ॗॢ-ॣ०-९ঁ-ঃ়া-ৄেৈৗয়-ৠਁ-ਃ਼ਾ-ੂੇੈੋ-੍ੑ੦-ੱੵઁ-ઃ઼ા-ૅે-ૉો-્ૢ-ૣ૦-૯ଁ-ଃ଼ା-ୄେୈୋ-୍ୖୗୟ-ୠ୦-୯ஂா-ூெ-ைொ-்ௗ௦-௯ఁ-ఃె-ైొ-్ౕౖౢ-ౣ౦-౯ಂಃ಼ಾ-ೄೆ-ೈೊ-್ೕೖೢ-ೣ೦-೯ംഃെ-ൈൗൢ-ൣ൦-൯ංඃ්ා-ුූෘ-ෟෲෳิ-ฺเ-ๅ๐-๙ິ-ູ່-ໍ໐-໙༘༙༠-༩༹༵༷ཁ-ཇཱ-྄྆-྇ྍ-ྗྙ-ྼ࿆က-ဩ၀-၉ၧ-ၭၱ-ၴႂ-ႍႏ-ႝ፝-፟ᜎ-ᜐᜠ-ᜰᝀ-ᝐᝲᝳក-ឲ៝០-៩᠋-᠍᠐-᠙ᤠ-ᤫᤰ-᤻ᥑ-ᥭᦰ-ᧀᧈ-ᧉ᧐-᧙ᨀ-ᨕᨠ-ᩓ᩠-᩿᩼-᪉᪐-᪙ᭆ-ᭋ᭐-᭙᭫-᭳᮰-᮹᯦-᯳ᰀ-ᰢ᱀-᱉ᱛ-ᱽ᳐-᳒ᴀ-ᶾḁ-ἕ‌‍‿⁀⁔⃐-⃥⃜⃡-⃰ⶁ-ⶖⷠ-ⷿ〡-〨゙゚Ꙁ-ꙭꙴ-꙽ꚟ꛰-꛱ꟸ-ꠀ꠆ꠋꠣ-ꠧꢀ-ꢁꢴ-꣄꣐-꣙ꣳ-ꣷ꤀-꤉ꤦ-꤭ꤰ-ꥅꦀ-ꦃ꦳-꧀ꨀ-ꨧꩀ-ꩁꩌ-ꩍ꩐-꩙ꩻꫠ-ꫩꫲ-ꫳꯀ-ꯡ꯬꯭꯰-꯹ﬠ-ﬨ︀-️︠-︦︳︴﹍-﹏０-９＿]"),
                        Ge = /[\n\r\u2028\u2029]/,
                        Je = /\r\n|[\n\r\u2028\u2029]/g,
        ...
        return c.inject(x), d.inject(x), D.inject(x), n && ("complete" === i.readyState ? setTimeout(f) : H.add(n, {
            load: f
        })), {
            compile: h,
            execute: u,
